...
local estudy_liandan = class("estudy_liandan", script_base)
estudy_liandan.script_id = 713519
estudy_liandan.g_MessageStudy = "如果你达到%d级并且肯花费#{_EXCHG%d}就可以学会炼丹技能。你决定学习么？"
estudy_liandan.g_AbilityID = define.ABILITY_LIANDAN
estudy_liandan.g_AbilityName = "炼丹"
function estudy_liandan:OnDefaultEvent(selfId, targetId, ButtomNum, g_Npc_ScriptId)
...
function estudy_liandan:OnEnumerate(caller, selfId, targetId, bid)
    caller:AddNumTextWithTarget(self.script_id, "学习" .. self.g_AbilityName .. "技能", 12, 0)
end

function estudy_liandan:CheckAccept()

end

function estudy_liandan:OnAccept()

end

return estudy_liandan
