...
local elevelup_jingmaibaijue = class("elevelup_jingmaibaijue", script_base)
elevelup_jingmaibaijue.script_id = 713592
elevelup_jingmaibaijue.g_nMaxLevel = 100
elevelup_jingmaibaijue.g_AbilityID = define.ABILITY_JINGMAIBAIJUE
elevelup_jingmaibaijue.g_AbilityName = "经脉百决"
function elevelup_jingmaibaijue:OnDefaultEvent(selfId, targetId, num, npc_script_id, bid)
...
function elevelup_jingmaibaijue:OnEnumerate(caller, selfId, targetId, arg, index)
    caller:AddNumTextWithTarget(self.script_id, "升级".. self.g_AbilityName.."技能", 12, 1)
end

function elevelup_jingmaibaijue:CheckAccept(selfId)

end

return elevelup_jingmaibaijue
