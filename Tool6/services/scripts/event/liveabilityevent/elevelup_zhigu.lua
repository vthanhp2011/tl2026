...
local elevelup_zhigu = class("elevelup_zhigu", script_base)
elevelup_zhigu.script_id = 713575
elevelup_zhigu.g_nMaxLevel = 10
elevelup_zhigu.g_AbilityID = define.ABILITY_ZHIGU
elevelup_zhigu.g_AbilityName = "制蛊"
function elevelup_zhigu:OnDefaultEvent(selfId, targetId, num, npc_script_id, bid)
...
function elevelup_zhigu:OnEnumerate(caller, selfId, targetId, arg, index)
    caller:AddNumTextWithTarget(self.script_id, "升级".. self.g_AbilityName.."技能", 12, 1)
end

function elevelup_zhigu:CheckAccept(selfId)

end

return elevelup_zhigu
