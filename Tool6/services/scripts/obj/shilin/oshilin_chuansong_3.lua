...
local oshilin_chuansong_3 = class("oshilin_chuansong_3", script_base)
oshilin_chuansong_3.script_id = 026032
oshilin_chuansong_3.g_city0 = 287
oshilin_chuansong_3.g_city1 = 305
oshilin_chuansong_3.g_city2 = 679
oshilin_chuansong_3.g_city3 = 697
function oshilin_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function oshilin_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
