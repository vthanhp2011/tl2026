...
local ochangbai_chuansong_2 = class("ochangbai_chuansong_2", script_base)
ochangbai_chuansong_2.script_id = 022031
ochangbai_chuansong_2.g_city0 = 253
ochangbai_chuansong_2.g_city1 = 271
ochangbai_chuansong_2.g_city2 = 645
ochangbai_chuansong_2.g_city3 = 663
function ochangbai_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function ochangbai_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
