...
local oxiaoyao_likuilei = class("oxiaoyao_likuilei", script_base)
oxiaoyao_likuilei.script_id = 014007
oxiaoyao_likuilei.g_xuanWuDaoId = 400918
oxiaoyao_likuilei.g_mpInfo = {}

oxiaoyao_likuilei.g_mpInfo[0] = {"星宿", 16, 96, 152, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XINGXIU}

oxiaoyao_likuilei.g_mpInfo[1] = {"逍遥", 14, 67, 145, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XIAOYAO}

oxiaoyao_likuilei.g_mpInfo[2] = {"少林", 9, 95, 137, define.MENPAI_ATTRIBUTE.MATTRIBUTE_SHAOLIN}

oxiaoyao_likuilei.g_mpInfo[3] = {"天山", 17, 95, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_TIANSHAN}

oxiaoyao_likuilei.g_mpInfo[4] = {"天龙", 13, 96, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_DALI}

oxiaoyao_likuilei.g_mpInfo[5] = {"峨嵋", 15, 89, 144, define.MENPAI_ATTRIBUTE.MATTRIBUTE_EMEI}

oxiaoyao_likuilei.g_mpInfo[6] = {"武当", 12, 103, 140, define.MENPAI_ATTRIBUTE.MATTRIBUTE_WUDANG}

oxiaoyao_likuilei.g_mpInfo[7] = {"明教", 11, 98, 167, define.MENPAI_ATTRIBUTE.MATTRIBUTE_MINGJIAO}

oxiaoyao_likuilei.g_mpInfo[8] = {"丐帮", 10, 91, 116, define.MENPAI_ATTRIBUTE.MATTRIBUTE_GAIBANG}

function oxiaoyao_likuilei:OnDefaultEvent(selfId, targetId)
    self:BeginEvent(self.script_id)
    self:AddText("#{OBJ_xiaoyao_0003}")
...
function oxiaoyao_likuilei:OnEventRequest(selfId, targetId, arg, index)
    if arg == self.g_xuanWuDaoId then
...
function oxiaoyao_likuilei:GotoShuHeGuZhen(selfId, targetId)
    self:CallScriptFunction((400900), "TransferFuncFromNpc", selfId, 420, 200, 211, 20)
    return
end

return oxiaoyao_likuilei
