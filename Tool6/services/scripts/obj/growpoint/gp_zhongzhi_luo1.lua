...
local gp_zhongzhi_luo1 = class("gp_zhongzhi_luo1", script_base)
gp_zhongzhi_luo1.g_GpId = 561
gp_zhongzhi_luo1.g_GpIdNext = 562
function gp_zhongzhi_luo1:OnRecycle(selfId, targetId)
