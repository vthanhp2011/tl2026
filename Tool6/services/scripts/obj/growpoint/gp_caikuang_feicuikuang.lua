...
local gp_caikuang_feicuikuang = class("gp_caikuang_feicuikuang", script_base)
gp_caikuang_feicuikuang.g_MainItemId = 20103008
gp_caikuang_feicuikuang.g_SubItemId = 50112003
gp_caikuang_feicuikuang.g_Byproduct = {20103020, 20103032, 20103044, 20103056}

gp_caikuang_feicuikuang.g_AbilityId = 7
gp_caikuang_feicuikuang.g_AbilityLevel = 8
function gp_caikuang_feicuikuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_feicuikuang:OnOpen(selfId, targetId)
...
return gp_caikuang_feicuikuang
