...
local gp_zhongzhi_huasheng3 = class("gp_zhongzhi_huasheng3", script_base)
gp_zhongzhi_huasheng3.g_GpId = 512
gp_zhongzhi_huasheng3.g_ItemBoxNeedLevel = 4
function gp_zhongzhi_huasheng3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_huasheng3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_huasheng3:OnRecycle(selfId, targetId)
    local num = 0
