...
local gp_zhongzhi_duan1 = class("gp_zhongzhi_duan1", script_base)
gp_zhongzhi_duan1.g_GpId = 555
gp_zhongzhi_duan1.g_GpIdNext = 556
function gp_zhongzhi_duan1:OnRecycle(selfId, targetId)
