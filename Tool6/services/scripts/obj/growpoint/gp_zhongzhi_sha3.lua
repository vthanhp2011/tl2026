...
local gp_zhongzhi_sha3 = class("gp_zhongzhi_sha3", script_base)
gp_zhongzhi_sha3.g_GpId = 569
gp_zhongzhi_sha3.g_ItemBoxNeedLevel = 11
function gp_zhongzhi_sha3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_sha3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_sha3:OnRecycle(selfId, targetId)
    local num = 0
