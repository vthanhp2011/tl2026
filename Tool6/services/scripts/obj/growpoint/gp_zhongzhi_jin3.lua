...
local gp_zhongzhi_jin3 = class("gp_zhongzhi_jin3", script_base)
gp_zhongzhi_jin3.g_GpId = 572
gp_zhongzhi_jin3.g_ItemBoxNeedLevel = 12
function gp_zhongzhi_jin3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_jin3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_jin3:OnRecycle(selfId, targetId)
    local num = 0
