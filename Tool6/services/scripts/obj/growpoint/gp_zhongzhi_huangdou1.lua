...
local gp_zhongzhi_huangdou1 = class("gp_zhongzhi_huangdou1", script_base)
gp_zhongzhi_huangdou1.g_GpId = 525
gp_zhongzhi_huangdou1.g_GpIdNext = 526
function gp_zhongzhi_huangdou1:OnRecycle(selfId, targetId)
