...
local gp_zhongzhi_chou3 = class("gp_zhongzhi_chou3", script_base)
gp_zhongzhi_chou3.g_GpId = 545
gp_zhongzhi_chou3.g_ItemBoxNeedLevel = 3
function gp_zhongzhi_chou3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_chou3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_chou3:OnRecycle(selfId, targetId)
    local num = 0
