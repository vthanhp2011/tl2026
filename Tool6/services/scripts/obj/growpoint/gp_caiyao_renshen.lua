...
local gp_caiyao_renshen = class("gp_caiyao_renshen", script_base)
gp_caiyao_renshen.g_MainItemId = 20101026
gp_caiyao_renshen.g_SubItemId = 20304014
gp_caiyao_renshen.g_AbilityId = 8
gp_caiyao_renshen.g_AbilityLevel = 10
function gp_caiyao_renshen:OnCreate(growPointType, x, y)
...
function gp_caiyao_renshen:OnOpen(selfId, targetId)
