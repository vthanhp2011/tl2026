...
local gp_zhongzhi_dami1 = class("gp_zhongzhi_dami1", script_base)
gp_zhongzhi_dami1.g_GpId = 504
gp_zhongzhi_dami1.g_GpIdNext = 505
function gp_zhongzhi_dami1:OnRecycle(selfId, targetId)
