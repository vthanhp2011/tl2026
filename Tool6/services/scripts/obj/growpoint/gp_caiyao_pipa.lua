...
local gp_caiyao_pipa = class("gp_caiyao_pipa", script_base)
gp_caiyao_pipa.g_MainItemId = 20101005
gp_caiyao_pipa.g_SubItemId = 20304006
gp_caiyao_pipa.g_AbilityId = 8
gp_caiyao_pipa.g_AbilityLevel = 2
function gp_caiyao_pipa:OnCreate(growPointType, x, y)
...
function gp_caiyao_pipa:OnOpen(selfId, targetId)
