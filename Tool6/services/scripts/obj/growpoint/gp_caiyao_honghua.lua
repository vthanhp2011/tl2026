...
local gp_caiyao_honghua = class("gp_caiyao_honghua", script_base)
gp_caiyao_honghua.g_MainItemId = 20101001
gp_caiyao_honghua.g_SubItemId = 20304005
gp_caiyao_honghua.g_AbilityId = 8
gp_caiyao_honghua.g_AbilityLevel = 1
function gp_caiyao_honghua:OnCreate(growPointType, x, y)
...
function gp_caiyao_honghua:OnOpen(selfId, targetId)
