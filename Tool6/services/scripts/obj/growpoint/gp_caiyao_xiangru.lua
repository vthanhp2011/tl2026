...
local gp_caiyao_xiangru = class("gp_caiyao_xiangru", script_base)
gp_caiyao_xiangru.g_MainItemId = 20101015
gp_caiyao_xiangru.g_SubItemId = 20304010
gp_caiyao_xiangru.g_AbilityId = 8
gp_caiyao_xiangru.g_AbilityLevel = 6
function gp_caiyao_xiangru:OnCreate(growPointType, x, y)
...
function gp_caiyao_xiangru:OnOpen(selfId, targetId)
