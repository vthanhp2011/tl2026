...
local gp_caiyao_lingli = class("gp_caiyao_lingli", script_base)
gp_caiyao_lingli.g_MainItemId = 20101030
gp_caiyao_lingli.g_SubItemId = 20304016
gp_caiyao_lingli.g_AbilityId = 8
gp_caiyao_lingli.g_AbilityLevel = 12
function gp_caiyao_lingli:OnCreate(growPointType, x, y)
...
function gp_caiyao_lingli:OnOpen(selfId, targetId)
