...
local gp_zhongzhi_juan3 = class("gp_zhongzhi_juan3", script_base)
gp_zhongzhi_juan3.g_GpId = 551
gp_zhongzhi_juan3.g_ItemBoxNeedLevel = 5
function gp_zhongzhi_juan3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_juan3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_juan3:OnRecycle(selfId, targetId)
    local num = 0
