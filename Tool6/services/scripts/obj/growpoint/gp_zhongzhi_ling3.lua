...
local gp_zhongzhi_ling3 = class("gp_zhongzhi_ling3", script_base)
gp_zhongzhi_ling3.g_GpId = 560
gp_zhongzhi_ling3.g_ItemBoxNeedLevel = 8
function gp_zhongzhi_ling3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_ling3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_ling3:OnRecycle(selfId, targetId)
    local num = 0
