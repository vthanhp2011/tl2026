...
local gp_caiyao_lingzhi = class("gp_caiyao_lingzhi", script_base)
gp_caiyao_lingzhi.g_MainItemId = 20101027
gp_caiyao_lingzhi.g_SubItemId = 20304016
gp_caiyao_lingzhi.g_AbilityId = 8
gp_caiyao_lingzhi.g_AbilityLevel = 12
function gp_caiyao_lingzhi:OnCreate(growPointType, x, y)
...
function gp_caiyao_lingzhi:OnOpen(selfId, targetId)
