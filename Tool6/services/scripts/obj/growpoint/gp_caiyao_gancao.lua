...
local gp_caiyao_gancao = class("gp_caiyao_gancao", script_base)
gp_caiyao_gancao.g_MainItemId = 20101006
gp_caiyao_gancao.g_SubItemId = 20304007
gp_caiyao_gancao.g_AbilityId = 8
gp_caiyao_gancao.g_AbilityLevel = 3
function gp_caiyao_gancao:OnCreate(growPointType, x, y)
...
function gp_caiyao_gancao:OnOpen(selfId, targetId)
