...
local gp_caiyao_shuanghua = class("gp_caiyao_shuanghua", script_base)
gp_caiyao_shuanghua.g_MainItemId = 20101007
gp_caiyao_shuanghua.g_SubItemId = 20304007
gp_caiyao_shuanghua.g_AbilityId = 8
gp_caiyao_shuanghua.g_AbilityLevel = 3
function gp_caiyao_shuanghua:OnCreate(growPointType, x, y)
...
function gp_caiyao_shuanghua:OnOpen(selfId, targetId)
