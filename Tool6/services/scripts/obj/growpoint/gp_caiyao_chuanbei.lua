...
local gp_caiyao_chuanbei = class("gp_caiyao_chuanbei", script_base)
gp_caiyao_chuanbei.g_MainItemId = 20101003
gp_caiyao_chuanbei.g_SubItemId = 20304006
gp_caiyao_chuanbei.g_AbilityId = 8
gp_caiyao_chuanbei.g_AbilityLevel = 5
function gp_caiyao_chuanbei:OnCreate(growPointType, x, y)
...
function gp_caiyao_chuanbei:OnOpen(selfId, targetId)
