...
local gp_zhongzhi_duan3 = class("gp_zhongzhi_duan3", script_base)
gp_zhongzhi_duan3.g_GpId = 557
gp_zhongzhi_duan3.g_ItemBoxNeedLevel = 7
function gp_zhongzhi_duan3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_duan3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_duan3:OnRecycle(selfId, targetId)
    local num = 0
