...
local gp_caikuang_shuijingkuang = class("gp_caikuang_shuijingkuang", script_base)
gp_caikuang_shuijingkuang.g_MainItemId = 20103007
gp_caikuang_shuijingkuang.g_SubItemId = 50112002
gp_caikuang_shuijingkuang.g_Byproduct = {20103019, 20103031, 20103043, 20103055}

gp_caikuang_shuijingkuang.g_AbilityId = 7
gp_caikuang_shuijingkuang.g_AbilityLevel = 7
function gp_caikuang_shuijingkuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_shuijingkuang:OnOpen(selfId, targetId)
...
return gp_caikuang_shuijingkuang
