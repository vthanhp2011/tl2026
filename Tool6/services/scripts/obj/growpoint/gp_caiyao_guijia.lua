...
local gp_caiyao_guijia = class("gp_caiyao_guijia", script_base)
gp_caiyao_guijia.g_MainItemId = 20101028
gp_caiyao_guijia.g_SubItemId = 20304015
gp_caiyao_guijia.g_AbilityId = 8
gp_caiyao_guijia.g_AbilityLevel = 11
function gp_caiyao_guijia:OnCreate(growPointType, x, y)
...
function gp_caiyao_guijia:OnOpen(selfId, targetId)
