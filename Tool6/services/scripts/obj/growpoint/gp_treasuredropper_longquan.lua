...
local gp_treasuredropper_longquan = class("gp_treasuredropper_longquan", script_base)
gp_treasuredropper_longquan.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_longquan.g_TickCreate_Msg = ""
gp_treasuredropper_longquan.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.293,
        ["numOdd"] = {
...
function gp_treasuredropper_longquan:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_longquan:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_longquan:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_longquan:OnOpen(selfId, targetId)
end

function gp_treasuredropper_longquan:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_longquan:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_longquan:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_longquan
