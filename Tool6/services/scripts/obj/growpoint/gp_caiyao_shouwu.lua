...
local gp_caiyao_shouwu = class("gp_caiyao_shouwu", script_base)
gp_caiyao_shouwu.g_MainItemId = 20101022
gp_caiyao_shouwu.g_SubItemId = 20304012
gp_caiyao_shouwu.g_AbilityId = 8
gp_caiyao_shouwu.g_AbilityLevel = 8
function gp_caiyao_shouwu:OnCreate(growPointType, x, y)
...
function gp_caiyao_shouwu:OnOpen(selfId, targetId)
