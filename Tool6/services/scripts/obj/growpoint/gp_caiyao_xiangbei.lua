...
local gp_caiyao_xiangbei = class("gp_caiyao_xiangbei", script_base)
gp_caiyao_xiangbei.g_MainItemId = 20101025
gp_caiyao_xiangbei.g_SubItemId = 20304013
gp_caiyao_xiangbei.g_AbilityId = 8
gp_caiyao_xiangbei.g_AbilityLevel = 9
function gp_caiyao_xiangbei:OnCreate(growPointType, x, y)
...
function gp_caiyao_xiangbei:OnOpen(selfId, targetId)
