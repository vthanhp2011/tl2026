...
local gp_zhongzhi_ma1 = class("gp_zhongzhi_ma1", script_base)
gp_zhongzhi_ma1.g_GpId = 537
gp_zhongzhi_ma1.g_GpIdNext = 538
function gp_zhongzhi_ma1:OnRecycle(selfId, targetId)
