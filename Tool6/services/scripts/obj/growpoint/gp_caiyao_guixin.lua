...
local gp_caiyao_guixin = class("gp_caiyao_guixin", script_base)
gp_caiyao_guixin.g_MainItemId = 20101018
gp_caiyao_guixin.g_SubItemId = 20304011
gp_caiyao_guixin.g_AbilityId = 8
gp_caiyao_guixin.g_AbilityLevel = 7
function gp_caiyao_guixin:OnCreate(growPointType, x, y)
...
function gp_caiyao_guixin:OnOpen(selfId, targetId)
