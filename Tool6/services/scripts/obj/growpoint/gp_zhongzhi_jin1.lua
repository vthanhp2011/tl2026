...
local gp_zhongzhi_jin1 = class("gp_zhongzhi_jin1", script_base)
gp_zhongzhi_jin1.g_GpId = 570
gp_zhongzhi_jin1.g_GpIdNext = 571
function gp_zhongzhi_jin1:OnRecycle(selfId, targetId)
