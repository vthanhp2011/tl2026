...
local gp_zhongzhi_zhima1 = class("gp_zhongzhi_zhima1", script_base)
gp_zhongzhi_zhima1.g_GpId = 5193
gp_zhongzhi_zhima1.g_GpIdNext = 520
function gp_zhongzhi_zhima1:OnRecycle(selfId, targetId)
