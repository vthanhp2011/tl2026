...
local gp_caikuang_zhenwukuang = class("gp_caikuang_zhenwukuang", script_base)
gp_caikuang_zhenwukuang.g_MainItemId = 20103009
gp_caikuang_zhenwukuang.g_SubItemId = 50112004
gp_caikuang_zhenwukuang.g_Byproduct = {20103021, 20103033, 20103045, 20103057}

gp_caikuang_zhenwukuang.g_AbilityId = 7
gp_caikuang_zhenwukuang.g_AbilityLevel = 9
function gp_caikuang_zhenwukuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_zhenwukuang:OnOpen(selfId, targetId)
...
return gp_caikuang_zhenwukuang
