...
local gp_treasuredropper_wuliang = class("gp_treasuredropper_wuliang", script_base)
gp_treasuredropper_wuliang.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_wuliang.g_TickCreate_Msg = ""
gp_treasuredropper_wuliang.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.293,
        ["numOdd"] = {
...
function gp_treasuredropper_wuliang:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_wuliang:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_wuliang:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_wuliang:OnOpen(selfId, targetId)
end

function gp_treasuredropper_wuliang:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_wuliang:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_wuliang:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_wuliang
