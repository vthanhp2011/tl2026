...
local gp_caiyao_huangqin = class("gp_caiyao_huangqin", script_base)
gp_caiyao_huangqin.g_MainItemId = 20101008
gp_caiyao_huangqin.g_SubItemId = 20304007
gp_caiyao_huangqin.g_AbilityId = 8
gp_caiyao_huangqin.g_AbilityLevel = 3
function gp_caiyao_huangqin:OnCreate(growPointType, x, y)
...
function gp_caiyao_huangqin:OnOpen(selfId, targetId)
