...
local oxihu_chuansong_1 = class("oxihu_chuansong_1", script_base)
oxihu_chuansong_1.script_id = 030030
oxihu_chuansong_1.g_city0 = 207
oxihu_chuansong_1.g_city1 = 225
oxihu_chuansong_1.g_city2 = 599
oxihu_chuansong_1.g_city3 = 617
function oxihu_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function oxihu_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
