...
local item_4632 = class("item_4632", script_base)
item_4632.g_petCommonId = define.PETCOMMON
item_4632.script_id = 334632
item_4632.g_HPValue = 2516
item_4632.g_MaxHPValue = 0
item_4632.g_LifeValue = 0
item_4632.g_HappinessValue = 0
function item_4632:IsSkillLikeScript(selfId)
    return 1
end

function item_4632:OnConditionCheck(selfId)
...
function item_4632:OnDeplete(selfId)
...
function item_4632:OnActivateOnce(selfId)
...
function item_4632:OnActivateEachTick(selfId)
    return 1
end

function item_4632:CancelImpacts(selfId)
    return 0
end
