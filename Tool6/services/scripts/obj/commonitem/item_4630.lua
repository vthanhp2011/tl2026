...
local item_4630 = class("item_4630", script_base)
item_4630.g_petCommonId = define.PETCOMMON
item_4630.script_id = 334630
item_4630.g_HPValue = 13780
item_4630.g_MaxHPValue = 0
item_4630.g_LifeValue = 0
item_4630.g_HappinessValue = 0
function item_4630:IsSkillLikeScript(selfId)
    return 1
end

function item_4630:OnConditionCheck(selfId)
...
function item_4630:OnDeplete(selfId)
...
function item_4630:OnActivateOnce(selfId)
...
function item_4630:OnActivateEachTick(selfId)
    return 1
end

function item_4630:CancelImpacts(selfId)
    return 0
end
