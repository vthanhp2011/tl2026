...
local item_4602 = class("item_4602", script_base)
item_4602.g_petCommonId = define.PETCOMMON
item_4602.script_id = 334602
item_4602.g_HPValue = 2516
item_4602.g_MaxHPValue = 0
item_4602.g_LifeValue = 0
item_4602.g_HappinessValue = 0
function item_4602:IsSkillLikeScript(selfId)
    return 1
end

function item_4602:OnConditionCheck(selfId)
...
function item_4602:OnDeplete(selfId)
...
function item_4602:OnActivateOnce(selfId)
...
function item_4602:OnActivateEachTick(selfId)
    return 1
end

function item_4602:CancelImpacts(selfId)
    return 0
end
