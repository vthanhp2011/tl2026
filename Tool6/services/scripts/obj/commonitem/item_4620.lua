...
local item_4620 = class("item_4620", script_base)
item_4620.g_petCommonId = define.PETCOMMON
item_4620.script_id = 334620
item_4620.g_HPValue = 13780
item_4620.g_MaxHPValue = 0
item_4620.g_LifeValue = 0
item_4620.g_HappinessValue = 0
function item_4620:IsSkillLikeScript(selfId)
    return 1
end

function item_4620:OnConditionCheck(selfId)
...
function item_4620:OnDeplete(selfId)
...
function item_4620:OnActivateOnce(selfId)
...
function item_4620:OnActivateEachTick(selfId)
    return 1
end

function item_4620:CancelImpacts(selfId)
    return 0
end
