...
local item_4629 = class("item_4629", script_base)
item_4629.g_petCommonId = define.PETCOMMON
item_4629.script_id = 334629
item_4629.g_HPValue = 12372
item_4629.g_MaxHPValue = 0
item_4629.g_LifeValue = 0
item_4629.g_HappinessValue = 0
function item_4629:IsSkillLikeScript(selfId)
    return 1
end

function item_4629:OnConditionCheck(selfId)
...
function item_4629:OnDeplete(selfId)
...
function item_4629:OnActivateOnce(selfId)
...
function item_4629:OnActivateEachTick(selfId)
    return 1
end

function item_4629:CancelImpacts(selfId)
    return 0
end
