...
local item_4638 = class("item_4638", script_base)
item_4638.g_petCommonId = define.PETCOMMON
item_4638.script_id = 334638
item_4638.g_HPValue = 10964
item_4638.g_MaxHPValue = 0
item_4638.g_LifeValue = 0
item_4638.g_HappinessValue = 0
function item_4638:IsSkillLikeScript(selfId)
return 1
end

function item_4638:OnConditionCheck(selfId)
...
function item_4638:OnDeplete(selfId)
...
function item_4638:OnActivateOnce(selfId)
...
function item_4638:OnActivateEachTick(selfId)
return 1
end

function item_4638:CancelImpacts(selfId)
return 0
end
