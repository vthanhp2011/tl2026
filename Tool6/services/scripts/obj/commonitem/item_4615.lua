...
local item_4615 = class("item_4615", script_base)
item_4615.g_petCommonId = define.PETCOMMON
item_4615.script_id = 334615
item_4615.g_HPValue = 6740
item_4615.g_MaxHPValue = 0
item_4615.g_LifeValue = 0
item_4615.g_HappinessValue = 0
function item_4615:IsSkillLikeScript(selfId)
    return 1
end

function item_4615:OnConditionCheck(selfId)
...
function item_4615:OnDeplete(selfId)
...
function item_4615:OnActivateOnce(selfId)
...
function item_4615:OnActivateEachTick(selfId)
    return 1
end

function item_4615:CancelImpacts(selfId)
    return 0
end
