...
local item_4612 = class("item_4612", script_base)
item_4612.g_petCommonId = define.PETCOMMON
item_4612.script_id = 334612
item_4612.g_HPValue = 2516
item_4612.g_MaxHPValue = 0
item_4612.g_LifeValue = 0
item_4612.g_HappinessValue = 0
function item_4612:IsSkillLikeScript(selfId)
    return 1
end

function item_4612:OnConditionCheck(selfId)
...
function item_4612:OnDeplete(selfId)
...
function item_4612:OnActivateOnce(selfId)
...
function item_4612:OnActivateEachTick(selfId)
    return 1
end

function item_4612:CancelImpacts(selfId)
    return 0
end
