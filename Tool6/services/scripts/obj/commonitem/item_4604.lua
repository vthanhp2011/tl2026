...
local item_4604 = class("item_4604", script_base)
item_4604.g_petCommonId = define.PETCOMMON
item_4604.script_id = 334604
item_4604.g_HPValue = 5332
item_4604.g_MaxHPValue = 0
item_4604.g_LifeValue = 0
item_4604.g_HappinessValue = 0
function item_4604:IsSkillLikeScript(selfId)
    return 1
end

function item_4604:OnConditionCheck(selfId)
...
function item_4604:OnDeplete(selfId)
...
function item_4604:OnActivateOnce(selfId)
...
function item_4604:OnActivateEachTick(selfId)
    return 1
end

function item_4604:CancelImpacts(selfId)
    return 0
end
