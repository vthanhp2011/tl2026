...
local onanhai_chuansong_1 = class("onanhai_chuansong_1", script_base)
onanhai_chuansong_1.script_id = 034030
onanhai_chuansong_1.g_city0 = 219
onanhai_chuansong_1.g_city1 = 237
onanhai_chuansong_1.g_city2 = 611
onanhai_chuansong_1.g_city3 = 629
function onanhai_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function onanhai_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
