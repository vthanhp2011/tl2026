...
local oyannan_chuansong_2 = class("oyannan_chuansong_2", script_base)
oyannan_chuansong_2.script_id = 018031
oyannan_chuansong_2.g_city0 = 241
oyannan_chuansong_2.g_city1 = 259
oyannan_chuansong_2.g_city2 = 633
oyannan_chuansong_2.g_city3 = 651
function oyannan_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function oyannan_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
