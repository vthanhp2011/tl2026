...
local olongquan_chuansong_2 = class("olongquan_chuansong_2", script_base)
olongquan_chuansong_2.script_id = 031031
olongquan_chuansong_2.g_city0 = 244
olongquan_chuansong_2.g_city1 = 262
olongquan_chuansong_2.g_city2 = 636
olongquan_chuansong_2.g_city3 = 654
function olongquan_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function olongquan_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
