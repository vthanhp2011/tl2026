...
local ohuanglong_chuansong_2 = class("ohuanglong_chuansong_2", script_base)
ohuanglong_chuansong_2.script_id = 023031
ohuanglong_chuansong_2.g_city0 = 254
ohuanglong_chuansong_2.g_city1 = 272
ohuanglong_chuansong_2.g_city2 = 646
ohuanglong_chuansong_2.g_city3 = 664
function ohuanglong_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function ohuanglong_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
