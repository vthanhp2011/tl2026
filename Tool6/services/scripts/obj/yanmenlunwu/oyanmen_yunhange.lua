...
local oyanmen_yunhange = class("oyanmen_yunhange", script_base)
oyanmen_yunhange.ID = {49901,49902,49903,49904,49905,49906}
oyanmen_yunhange.Title = 3
oyanmen_yunhange.script_id = 893134
oyanmen_yunhange.g_FuBenScriptId = 893131
oyanmen_yunhange.g_MonsterAI = 893143
function oyanmen_yunhange:OnDefaultEvent(selfId,targetId)
	self:BeginEvent(self.script_id)
		self:AddText("#{MPCG_191029_138}")
		self:AddNumText("#{MPCG_191029_24}",10,1)
	self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end

function oyanmen_yunhange:OnEventRequest(selfId,targetId,arg,index)
...
function oyanmen_yunhange:MsgBox(selfId,targetId,str)
	self:BeginEvent(self.script_id)
		self:AddText(str)
		self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end
return oyanmen_yunhange