...
local oyanmen_yinlianyou = class("oyanmen_yinlianyou", script_base)
oyanmen_yinlianyou.ID = {49929,49930,49931,49932,49933,49934}
oyanmen_yinlianyou.Title = 7
oyanmen_yinlianyou.script_id = 893138
oyanmen_yinlianyou.g_FuBenScriptId = 893131
oyanmen_yinlianyou.g_MonsterAI = 893147
function oyanmen_yinlianyou:OnDefaultEvent(selfId,targetId)
	self:BeginEvent(self.script_id)
		self:AddText("#{MPCG_191029_400}")
		self:AddNumText("#{MPCG_191029_24}",10,1)
	self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end

function oyanmen_yinlianyou:OnEventRequest(selfId,targetId,arg,index)
...
function oyanmen_yinlianyou:MsgBox(selfId,targetId,str)
	self:BeginEvent(self.script_id)
		self:AddText(str)
		self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end
return oyanmen_yinlianyou