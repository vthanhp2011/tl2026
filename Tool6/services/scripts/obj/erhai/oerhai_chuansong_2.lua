...
local oerhai_chuansong_2 = class("oerhai_chuansong_2", script_base)
oerhai_chuansong_2.script_id = 024031
oerhai_chuansong_2.g_city0 = 246
oerhai_chuansong_2.g_city1 = 264
oerhai_chuansong_2.g_city2 = 638
oerhai_chuansong_2.g_city3 = 656
function oerhai_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function oerhai_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
