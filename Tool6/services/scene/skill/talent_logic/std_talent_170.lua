...
local std_talent_170 = class("std_talent_170", base)
function std_talent_170:get_refix_value(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_170:refix_skill_info(talent, level, skill_info, human)
    ...
    if reciver and reciver:impact_have_impact_of_specific_impact_id(175) then
