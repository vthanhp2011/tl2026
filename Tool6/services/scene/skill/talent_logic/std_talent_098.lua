...
local std_talent_098 = class("std_talent_098", base)

function std_talent_098:is_specific_impact(impact_id)
    return impact_id == 10
end

function std_talent_098:is_specific_skill(skill_id)
    return skill_id == 411
end

function std_talent_098:get_refix_value(talent, level)
    local params = talent.params[level]
    return params[1]
end

function std_talent_098:refix_impact(talent, level, imp, sender, reciver)
