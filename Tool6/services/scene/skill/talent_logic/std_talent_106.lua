...
local std_talent_106 = class("std_talent_106", base)
function std_talent_106:is_specific_skill(skill_id)
    return skill_id == 403
end

function std_talent_106:get_odd(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_106:on_hit_target(talent, level, sender, reciver, skill_id)
