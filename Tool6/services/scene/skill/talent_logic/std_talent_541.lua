...
function std_talent_541:on_damage_target(talent, level, id, sender, reciver, damages, skill_id, imp)
    if sender:impact_have_impact_of_specific_impact_id(3866) then
