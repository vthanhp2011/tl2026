...
function span_human:get_relation_info()
    return cluster.call(self:get_node_name(), ".clusteragentproxy", "call_agent", self:get_guid(), "get_relation_list")
end

function span_human:set_relation_info(realtion_list)
    cluster.send(self:get_node_name(), ".clusteragentproxy", "send_agent", self:get_guid(), "set_realtion_list", realtion_list)
end
...
function span_human:check_right_limit_exchange()
    return cluster.call(self:get_node_name(), ".clusteragentproxy","call_agent", self:get_guid(), "check_right_limit_exchange")
end
