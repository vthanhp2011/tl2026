...
skynet.start(function()
	...
	-- 2. Khởi tạo .service (bỏ vì không dùng service.new nữa)
	-- local service_addr = skynet.newservice("service")  -- Bỏ
	-- skynet.sleep(200)   -- bỏ
	...
	if enablessl then
		...
		if ok and ltls then
			...
			-- skynet.uniqueservice(".service")  -- Bỏ vì đã launch ở trên
			
			skynet.newservice("ltls_holder")  -- Launch ltls_holder.lua trực tiếp
		else
	...
	if enablecipher then
		skynet.newservice("lcipher_holder")  -- Launch lcipher_holder.lua trực tiếp
	end
