...
local estudy_yinchongshu = class("estudy_yinchongshu", script_base)
estudy_yinchongshu.script_id = 713534
estudy_yinchongshu.g_MessageStudy = "如果你达到%d级并且肯花费#{_EXCHG%d}就可以学会引虫术技能。你决定学习么？"
estudy_yinchongshu.g_AbilityID = define.ABILITY_YINCHONGSHU
estudy_yinchongshu.g_AbilityName = "引虫术"
function estudy_yinchongshu:OnDefaultEvent(selfId, targetId, ButtomNum, g_Npc_ScriptId)
...
function estudy_yinchongshu:OnEnumerate(caller, selfId, targetId, bid)
    caller:AddNumTextWithTarget(self.script_id, "学习" .. self.g_AbilityName .. "技能", 12, 0)
end

function estudy_yinchongshu:CheckAccept()

end

function estudy_yinchongshu:OnAccept()

end

return estudy_yinchongshu
