...
local estudy_jingmaibaijue = class("estudy_jingmaibaijue", script_base)
estudy_jingmaibaijue.script_id = 713533
estudy_jingmaibaijue.g_MessageStudy = "如果你达到%d级并且肯花费#{_EXCHG%d}就可以学会经脉百决技能。你决定学习么？"
estudy_jingmaibaijue.g_AbilityID = define.ABILITY_JINGMAIBAIJUE
estudy_jingmaibaijue.g_AbilityName = "经脉百决"
function estudy_jingmaibaijue:OnDefaultEvent(selfId, targetId, ButtomNum, g_Npc_ScriptId)
...
function estudy_jingmaibaijue:OnEnumerate(caller, selfId, targetId, bid)
    caller:AddNumTextWithTarget(self.script_id, "学习" .. self.g_AbilityName .. "技能", 12, 0)
end

function estudy_jingmaibaijue:CheckAccept()

end

function estudy_jingmaibaijue:OnAccept()

end

return estudy_jingmaibaijue
