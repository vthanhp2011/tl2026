...
local item_4631 = class("item_4631", script_base)
item_4631.g_petCommonId = define.PETCOMMON
item_4631.script_id = 334631
item_4631.g_HPValue = 1108
item_4631.g_MaxHPValue = 0
item_4631.g_LifeValue = 0
item_4631.g_HappinessValue = 0
function item_4631:IsSkillLikeScript(selfId)
    return 1
end

function item_4631:OnConditionCheck(selfId)
...
function item_4631:OnDeplete(selfId)
...
function item_4631:OnActivateOnce(selfId)
...
function item_4631:OnActivateEachTick(selfId)
    return 1
end

function item_4631:CancelImpacts(selfId)
    return 0
end
