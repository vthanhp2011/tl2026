...
local item_4610 = class("item_4610", script_base)
item_4610.g_petCommonId = define.PETCOMMON
item_4610.script_id = 334610
item_4610.g_HPValue = 13780
item_4610.g_MaxHPValue = 0
item_4610.g_LifeValue = 0
item_4610.g_HappinessValue = 0
function item_4610:IsSkillLikeScript(selfId)
    return 1
end

function item_4610:OnConditionCheck(selfId)
...
function item_4610:OnDeplete(selfId)
...
function item_4610:OnActivateOnce(selfId)
...
function item_4610:OnActivateEachTick(selfId)
    return 1
end

function item_4610:CancelImpacts(selfId)
    return 0
end
