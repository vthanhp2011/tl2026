...
local item_4636 = class("item_4636", script_base)
item_4636.g_petCommonId = define.PETCOMMON
item_4636.script_id = 334636
item_4636.g_HPValue = 8148
item_4636.g_MaxHPValue = 0
item_4636.g_LifeValue = 0
item_4636.g_HappinessValue = 0
function item_4636:IsSkillLikeScript(selfId)
    return 1
end

function item_4636:OnConditionCheck(selfId)
...
function item_4636:OnDeplete(selfId)
...
function item_4636:OnActivateOnce(selfId)
...
function item_4636:OnActivateEachTick(selfId)
    return 1
end

function item_4636:CancelImpacts(selfId)
    return 0
end
