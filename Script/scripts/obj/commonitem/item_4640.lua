...
local item_4640 = class("item_4640", script_base)
item_4640.g_petCommonId = define.PETCOMMON
item_4640.script_id = 334640
item_4640.g_HPValue = 13780
item_4640.g_MaxHPValue = 0
item_4640.g_LifeValue = 0
item_4640.g_HappinessValue = 0
function item_4640:IsSkillLikeScript(selfId)
    return 1
end

function item_4640:OnConditionCheck(selfId)
...
function item_4640:OnDeplete(selfId)
...
function item_4640:OnActivateOnce(selfId)
...
function item_4640:OnActivateEachTick(selfId)
    return 1
end

function item_4640:CancelImpacts(selfId)
    return 0
end
