...
local item_4609 = class("item_4609", script_base)
item_4609.g_petCommonId = define.PETCOMMON
item_4609.script_id = 334609
item_4609.g_HPValue = 12372
item_4609.g_MaxHPValue = 0
item_4609.g_LifeValue = 0
item_4609.g_HappinessValue = 0
function item_4609:IsSkillLikeScript(selfId)
    return 1
end

function item_4609:OnConditionCheck(selfId)
...
function item_4609:OnDeplete(selfId)
...
function item_4609:OnActivateOnce(selfId)
...
function item_4609:OnActivateEachTick(selfId)
    return 1
end

function item_4609:CancelImpacts(selfId)
    return 0
end
