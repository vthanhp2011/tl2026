...
function common_item:OnActivateOnce(selfId)
    ...
    self:TryRecieveItem(selfId, 10124753, false)
    self:TryRecieveItem(selfId, 20307207, false)
    self:TryRecieveItem(selfId, 30008194, false)
	return 1
end
