...
local item_4606 = class("item_4606", script_base)
item_4606.g_petCommonId = define.PETCOMMON
item_4606.script_id = 334606
item_4606.g_HPValue = 8148
item_4606.g_MaxHPValue = 0
item_4606.g_LifeValue = 0
item_4606.g_HappinessValue = 0
function item_4606:IsSkillLikeScript(selfId)
    return 1
end

function item_4606:OnConditionCheck(selfId)
...
function item_4606:OnDeplete(selfId)
...
function item_4606:OnActivateOnce(selfId)
...
function item_4606:OnActivateEachTick(selfId)
    return 1
end

function item_4606:CancelImpacts(selfId)
    return 0
end
