...
local oshaolin_huilun = class("oshaolin_huilun", script_base)
oshaolin_huilun.script_id = 009009
oshaolin_huilun.g_xuanWuDaoId = 400918
oshaolin_huilun.g_mpInfo = {}

oshaolin_huilun.g_mpInfo[0] = {"星宿", 16, 96, 152, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XINGXIU}

oshaolin_huilun.g_mpInfo[1] = {"逍遥", 14, 67, 145, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XIAOYAO}

oshaolin_huilun.g_mpInfo[2] = {"少林", 9, 95, 137, define.MENPAI_ATTRIBUTE.MATTRIBUTE_SHAOLIN}

oshaolin_huilun.g_mpInfo[3] = {"天山", 17, 95, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_TIANSHAN}

oshaolin_huilun.g_mpInfo[4] = {"天龙", 13, 96, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_DALI}

oshaolin_huilun.g_mpInfo[5] = {"峨嵋", 15, 89, 144, define.MENPAI_ATTRIBUTE.MATTRIBUTE_EMEI}

oshaolin_huilun.g_mpInfo[6] = {"武当", 12, 103, 140, define.MENPAI_ATTRIBUTE.MATTRIBUTE_WUDANG}

oshaolin_huilun.g_mpInfo[7] = {"明教", 11, 98, 167, define.MENPAI_ATTRIBUTE.MATTRIBUTE_MINGJIAO}

oshaolin_huilun.g_mpInfo[8] = {"丐帮", 10, 91, 116, define.MENPAI_ATTRIBUTE.MATTRIBUTE_GAIBANG}

function oshaolin_huilun:OnDefaultEvent(selfId, targetId)
    self:BeginEvent(self.script_id)
    self:AddText("#{OBJ_shaolin_0002}")
...
function oshaolin_huilun:OnEventRequest(selfId, targetId, arg, index)
...
function oshaolin_huilun:GotoShuHeGuZhen(selfId, targetId)
    self:CallScriptFunction((400900), "TransferFuncFromNpc", selfId, 420, 200, 211, 20)
    return
end

return oshaolin_huilun
