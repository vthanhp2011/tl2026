...
local LingWuGoods = {
    [38002817] = { price = 1350, limit = 10 },
    [38002817] = { price = 1350, limit = 10  },
    [38002812] = { price = 3600, limit = 1  },

    [38002800] = { price = 900, limit = 15 },
    [38002799] = { price = 900, limit = 15 },
    [38002802] = { price = 900, limit = 15 },
    [38002801] = { price = 900, limit = 15 },
    [38002804] = { price = 900, limit = 15 },
    [38002803] = { price = 900, limit = 15 },

    [20600003] = { price = 18000, limit = 15 },
    [20600002] = { price = 3600, limit = 15 },
}
function obaixihu_mozhichou:YBbuyitem(selfId, targetId, Index, ItemId)
    ...
    if ret then
        ...
        self:LuaFnCostYuanBao(selfId, Goods.price)
