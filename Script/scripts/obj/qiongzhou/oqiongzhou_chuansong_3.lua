...
local oqiongzhou_chuansong_3 = class("oqiongzhou_chuansong_3", script_base)
oqiongzhou_chuansong_3.script_id = 035032
oqiongzhou_chuansong_3.g_city0 = 292
oqiongzhou_chuansong_3.g_city1 = 310
oqiongzhou_chuansong_3.g_city2 = 684
oqiongzhou_chuansong_3.g_city3 = 702
function oqiongzhou_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function oqiongzhou_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
