...
local otianlong_pochen = class("otianlong_pochen", script_base)
otianlong_pochen.script_id = 013005
otianlong_pochen.g_xuanWuDaoId = 400918
otianlong_pochen.g_mpInfo = {}

otianlong_pochen.g_mpInfo[0] = {"星宿", 16, 96, 152, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XINGXIU}

otianlong_pochen.g_mpInfo[1] = {"逍遥", 14, 67, 145, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XIAOYAO}

otianlong_pochen.g_mpInfo[2] = {"少林", 9, 95, 137, define.MENPAI_ATTRIBUTE.MATTRIBUTE_SHAOLIN}

otianlong_pochen.g_mpInfo[3] = {"天山", 17, 95, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_TIANSHAN}

otianlong_pochen.g_mpInfo[4] = {"天龙", 13, 96, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_DALI}

otianlong_pochen.g_mpInfo[5] = {"峨嵋", 15, 89, 144, define.MENPAI_ATTRIBUTE.MATTRIBUTE_EMEI}

otianlong_pochen.g_mpInfo[6] = {"武当", 12, 103, 140, define.MENPAI_ATTRIBUTE.MATTRIBUTE_WUDANG}

otianlong_pochen.g_mpInfo[7] = {"明教", 11, 98, 167, define.MENPAI_ATTRIBUTE.MATTRIBUTE_MINGJIAO}

otianlong_pochen.g_mpInfo[8] = {"丐帮", 10, 91, 116, define.MENPAI_ATTRIBUTE.MATTRIBUTE_GAIBANG}

function otianlong_pochen:OnDefaultEvent(selfId, targetId)
    self:BeginEvent(self.script_id)
    self:AddText("#{MPXL_090113_02}")
...
function otianlong_pochen:OnEventRequest(selfId, targetId, arg, index)
...
function otianlong_pochen:GotoShuHeGuZhen(selfId, targetId)
    self:CallScriptFunction((400900), "TransferFuncFromNpc", selfId, 420, 200, 211, 20)
    return
end

return otianlong_pochen
