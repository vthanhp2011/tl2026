...
local osangtugong = class("osangtugong", script_base)
osangtugong.script_id = 402271
-- 402271
--副本逻辑脚本号....
osangtugong.g_FuBenScriptId = 402263

--**********************************
--任务入口函数....
--**********************************
function osangtugong:OnDefaultEvent(selfId, targetId )
...
--事件列表选中一项
--**********************************
function osangtugong:OnEventRequest( selfId, targetId, eventId )
	--如果正在激活BOSS则返回....
...
--缥缈峰计时器的OnTimer....
--**********************************
function osangtugong:OnPMFTimer( step )
	if 7 == step then
