...
local LevelGiftInfo = {
    {
        level = 1,
        prize = {
            { itemid = 30900056, num = 1 }, { itemid = 30008002, num = 1 }, { itemid = 38002169, num = 1 },
        }
    },
    {
        level = 10,
        prize = {
            { itemid = 30900056, num = 2 }, { itemid = 10141036, num = 1 }, { itemid = 10141026, num = 1 },
    ...
    },
    {
        level = 15,
        prize = {
            { itemid = 30900056, num = 2 }, { itemid = 10142380, num = 1 }, { itemid = 38002169, num = 1 },
        }
    },
    {
        level = 25,
        prize = {
            { itemid = 30008102, num = 2 }, { itemid = 30505076, num = 2 }, { itemid = 10155001, num = 1 },
    ...
    },
    {
        level = 30,
        prize = {
            { itemid = 30008002, num = 1 }, { itemid = 30505076, num = 2 }, { itemid = 30900045, num = 2 },
    ...
    },
    {
        ...
        prize = {
            ...
            { itemid = 10156004, num = 1 }, { itemid = 38003158, num = 1 },
        }
    },
    {
        level = 50,
        prize = {
            { itemid = 38002397, num = 20 }, { itemid = 20310168, num = 100 }, { itemid = 30700241, num = 5 },
            { itemid = 38008005, num = 1 },
        }
    },
    {
        ...
        prize = {
            ...
            { itemid = 38008005, num = 2 }, { itemid = 20500003, num = 5 },
        }
    },
    {
        level = 90,
...
function odali_youxituiguang:OnEventRequest(selfId, targetId, arg, index)
    ...
    if index > 1000 and index < 1100 then
        ...
        local PropSpace = self:LuaFnGetMaterialBagSpace(selfId)
        local MaterialSpace = self:LuaFnGetMaterialBagSpace(selfId)
        if PropSpace < 5 then
            self:notify_tips(selfId, "道具栏需要5格空间")
            return
        end
        if MaterialSpace < 5 then
            self:notify_tips(selfId, "材料栏需要5格空间")
            return
        end
        --检测背包够不够
        self:BeginAddItem()
