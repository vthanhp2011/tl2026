...
local odali_zhongzhipai28 = class("odali_zhongzhipai28", script_base)
odali_zhongzhipai28.script_id = 714084
odali_zhongzhipai28.event_xuanzezhiwu = 713550
odali_zhongzhipai28.g_eventList = {
    20104001,
    20104002,
    20104005,
    20104007,
...
function odali_zhongzhipai28:OnDefaultEvent(selfId, targetId)
...
function odali_zhongzhipai28:OnEventRequest(selfId, targetId, arg, index)
    local name_Index
    local NumText = index
...
function odali_zhongzhipai28:OnMissionSubmit(selfId, targetId, scriptId)
    for i, findId in pairs(self.g_eventList) do
...
function odali_zhongzhipai28:OnMissionAccept(selfId, targetId, missionScriptId)
    for i, findId in pairs(self.g_eventList) do
