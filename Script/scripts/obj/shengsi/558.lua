...
function shaxing_title:OnEventRequest(selfId, targetId, arg, index)
    ...
    elseif index == 1000 then
        ...
        if c0 < 1 then
            ...
            local nam = self:LuaFnGetName(selfId)
            local strText = "#gff00f0恭喜玩家#gffff00" .. nam .. "#gff00f0成功领取称号广目天王"
    ...
    elseif index == 1001 then
        ...
        if c0 < 1 then
            ...
            local nam = self:LuaFnGetName(selfId)
            local strText = "#gff00f0恭喜玩家#gffff00" .. nam .. "#gff00f0成功领取称号多闻天王"
            strText = gbk.fromutf8(strText)
            self:BroadMsgByChatPipe(selfId, strText, 4)
            self:EndEvent()
            self:DispatchEventList(selfId, targetId)
    ...
    elseif index == 1002 then
        ...
        if c0 < 1 then
            ...
            local nam = self:LuaFnGetName(selfId)
            local strText = "#gff00f0恭喜玩家#gffff00" .. nam .. "#gff00f0成功领取称号增长天王"
            strText = gbk.fromutf8(strText)
            self:BroadMsgByChatPipe(selfId, strText, 4)
            self:EndEvent()
            self:DispatchEventList(selfId, targetId)
    ...
    elseif index == 1003 then
        ...
        if c0 < 1 then
            ...
            local nam = self:LuaFnGetName(selfId)
            local strText = "#gff00f0恭喜玩家#gffff00" .. nam .. "#gff00f0成功领取称号持国天王"
            strText = gbk.fromutf8(strText)
            self:BroadMsgByChatPipe(selfId, strText, 4)
            self:EndEvent()
            self:DispatchEventList(selfId, targetId)
