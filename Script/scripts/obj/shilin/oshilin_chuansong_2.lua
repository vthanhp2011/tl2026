...
local oshilin_chuansong_2 = class("oshilin_chuansong_2", script_base)
oshilin_chuansong_2.script_id = 026031
oshilin_chuansong_2.g_city0 = 251
oshilin_chuansong_2.g_city1 = 269
oshilin_chuansong_2.g_city2 = 643
oshilin_chuansong_2.g_city3 = 661
function oshilin_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function oshilin_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
