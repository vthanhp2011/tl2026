...
local gp_caiyao_gouqi = class("gp_caiyao_gouqi", script_base)
gp_caiyao_gouqi.g_MainItemId = 20101009
gp_caiyao_gouqi.g_SubItemId = 20304008
gp_caiyao_gouqi.g_AbilityId = 8
gp_caiyao_gouqi.g_AbilityLevel = 4
function gp_caiyao_gouqi:OnCreate(growPointType, x, y)
...
function gp_caiyao_gouqi:OnOpen(selfId, targetId)
