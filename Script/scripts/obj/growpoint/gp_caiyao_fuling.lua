...
local gp_caiyao_fuling = class("gp_caiyao_fuling", script_base)
gp_caiyao_fuling.g_MainItemId = 20101013
gp_caiyao_fuling.g_SubItemId = 20304009
gp_caiyao_fuling.g_AbilityId = 8
gp_caiyao_fuling.g_AbilityLevel = 5
function gp_caiyao_fuling:OnCreate(growPointType, x, y)
...
function gp_caiyao_fuling:OnOpen(selfId, targetId)
