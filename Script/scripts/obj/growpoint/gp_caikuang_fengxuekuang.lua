...
local gp_caikuang_fengxuekuang = class("gp_caikuang_fengxuekuang", script_base)
gp_caikuang_fengxuekuang.g_MainItemId = 20103011
gp_caikuang_fengxuekuang.g_SubItemId = 50101001
gp_caikuang_fengxuekuang.g_Byproduct = {20103023, 20103035, 20103047, 20103059}

gp_caikuang_fengxuekuang.g_AbilityId = 7
gp_caikuang_fengxuekuang.g_AbilityLevel = 11
function gp_caikuang_fengxuekuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_fengxuekuang:OnOpen(selfId, targetId)
...
return gp_caikuang_fengxuekuang
