...
local gp_caiyao_danggui = class("gp_caiyao_danggui", script_base)
gp_caiyao_danggui.g_MainItemId = 20101017
gp_caiyao_danggui.g_SubItemId = 20304010
gp_caiyao_danggui.g_AbilityId = 8
gp_caiyao_danggui.g_AbilityLevel = 6
function gp_caiyao_danggui:OnCreate(growPointType, x, y)
...
function gp_caiyao_danggui:OnOpen(selfId, targetId)
