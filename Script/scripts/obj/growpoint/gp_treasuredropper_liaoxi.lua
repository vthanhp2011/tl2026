...
local gp_treasuredropper_liaoxi = class("gp_treasuredropper_liaoxi", script_base)
gp_treasuredropper_liaoxi.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_liaoxi.g_TickCreate_Msg = ""
gp_treasuredropper_liaoxi.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.284,
        ["numOdd"] = {
...
function gp_treasuredropper_liaoxi:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_liaoxi:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_liaoxi:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_liaoxi:OnOpen(selfId, targetId)
end

function gp_treasuredropper_liaoxi:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_liaoxi:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_liaoxi:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_liaoxi
