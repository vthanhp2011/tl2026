...
local gp_caiyao_huanglian = class("gp_caiyao_huanglian", script_base)
gp_caiyao_huanglian.g_MainItemId = 20101016
gp_caiyao_huanglian.g_SubItemId = 20304010
gp_caiyao_huanglian.g_AbilityId = 8
gp_caiyao_huanglian.g_AbilityLevel = 6
function gp_caiyao_huanglian:OnCreate(growPointType, x, y)
...
function gp_caiyao_huanglian:OnOpen(selfId, targetId)
