...
local gp_treasuredropper_miaojiang = class("gp_treasuredropper_miaojiang", script_base)
gp_treasuredropper_miaojiang.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_miaojiang.g_TickCreate_Msg = ""
gp_treasuredropper_miaojiang.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.284,
        ["numOdd"] = {
...
function gp_treasuredropper_miaojiang:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_miaojiang:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_miaojiang:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_miaojiang:OnOpen(selfId, targetId)
end

function gp_treasuredropper_miaojiang:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_miaojiang:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_miaojiang:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_miaojiang
