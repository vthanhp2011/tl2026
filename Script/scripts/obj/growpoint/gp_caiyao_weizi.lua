...
local gp_caiyao_weizi = class("gp_caiyao_weizi", script_base)
gp_caiyao_weizi.g_MainItemId = 20101010
gp_caiyao_weizi.g_SubItemId = 20304008
gp_caiyao_weizi.g_AbilityId = 8
gp_caiyao_weizi.g_AbilityLevel = 4
function gp_caiyao_weizi:OnCreate(growPointType, x, y)
...
function gp_caiyao_weizi:OnOpen(selfId, targetId)
