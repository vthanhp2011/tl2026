...
local gp_zhongzhi_luo3 = class("gp_zhongzhi_luo3", script_base)
gp_zhongzhi_luo3.g_GpId = 563
gp_zhongzhi_luo3.g_ItemBoxNeedLevel = 9
function gp_zhongzhi_luo3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_luo3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_luo3:OnRecycle(selfId, targetId)
    local num = 0
