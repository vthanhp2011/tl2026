...
local gp_zhongzhi_si3 = class("gp_zhongzhi_si3", script_base)
gp_zhongzhi_si3.g_GpId = 554
gp_zhongzhi_si3.g_ItemBoxNeedLevel = 6
function gp_zhongzhi_si3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_si3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_si3:OnRecycle(selfId, targetId)
    local num = 0
