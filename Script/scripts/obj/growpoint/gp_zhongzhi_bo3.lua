...
local gp_zhongzhi_bo3 = class("gp_zhongzhi_bo3", script_base)
gp_zhongzhi_bo3.g_GpId = 548
gp_zhongzhi_bo3.g_ItemBoxNeedLevel = 4
function gp_zhongzhi_bo3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_bo3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_bo3:OnRecycle(selfId, targetId)
    local num = 0
