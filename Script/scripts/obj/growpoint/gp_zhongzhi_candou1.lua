...
local gp_zhongzhi_candou1 = class("gp_zhongzhi_candou1", script_base)
gp_zhongzhi_candou1.g_GpId = 528
gp_zhongzhi_candou1.g_GpIdNext = 529
function gp_zhongzhi_candou1:OnRecycle(selfId, targetId)
