...
local gp_zhongzhi_chou1 = class("gp_zhongzhi_chou1", script_base)
gp_zhongzhi_chou1.g_GpId = 543
gp_zhongzhi_chou1.g_GpIdNext = 544
function gp_zhongzhi_chou1:OnRecycle(selfId, targetId)
