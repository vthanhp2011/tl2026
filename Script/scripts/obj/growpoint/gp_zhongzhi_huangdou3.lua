...
local gp_zhongzhi_huangdou3 = class("gp_zhongzhi_huangdou3", script_base)
gp_zhongzhi_huangdou3.g_GpId = 527
gp_zhongzhi_huangdou3.g_ItemBoxNeedLevel = 9
function gp_zhongzhi_huangdou3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_huangdou3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_huangdou3:OnRecycle(selfId, targetId)
    local num = 0
