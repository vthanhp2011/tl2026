...
local gp_zhongzhi_hongshu1 = class("gp_zhongzhi_hongshu1", script_base)
gp_zhongzhi_hongshu1.g_GpId = 513
gp_zhongzhi_hongshu1.g_GpIdNext = 514
function gp_zhongzhi_hongshu1:OnRecycle(selfId, targetId)
