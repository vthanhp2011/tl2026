...
local gp_zhongzhi_gaoliang3 = class("gp_zhongzhi_gaoliang3", script_base)
gp_zhongzhi_gaoliang3.g_GpId = 518
gp_zhongzhi_gaoliang3.g_ItemBoxNeedLevel = 6
function gp_zhongzhi_gaoliang3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_gaoliang3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_gaoliang3:OnRecycle(selfId, targetId)
    local num = 0
