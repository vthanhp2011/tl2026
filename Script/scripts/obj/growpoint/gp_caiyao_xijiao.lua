...
local gp_caiyao_xijiao = class("gp_caiyao_xijiao", script_base)
gp_caiyao_xijiao.g_MainItemId = 20101024
gp_caiyao_xijiao.g_SubItemId = 20304014
gp_caiyao_xijiao.g_AbilityId = 8
gp_caiyao_xijiao.g_AbilityLevel = 10
function gp_caiyao_xijiao:OnCreate(growPointType, x, y)
...
function gp_caiyao_xijiao:OnOpen(selfId, targetId)
