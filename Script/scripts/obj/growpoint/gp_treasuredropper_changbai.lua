...
local gp_treasuredropper_changbai = class("gp_treasuredropper_changbai", script_base)
gp_treasuredropper_changbai.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_changbai.g_TickCreate_Msg = ""
gp_treasuredropper_changbai.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.284,
        ["numOdd"] = {
        ...
        ["idx"] = {30001004, 30003009, 30101039}
    },
    {
        ["itemType"] = 2,
        ["odd"] = 0.293,
    ...
    },
    {
        ...
        ["idx"] = {30602009, 30603009, 30604009, 30605009}
    },
    {
        ["itemType"] = 4,
        ["odd"] = 0.1,
    ...
    },
    {
        ...
        ["idx"] = {10100009, 10101009, 10102009, 10103009, 10104009, 10105009}
    },
    {
        ["itemType"] = 10,
        ["odd"] = 0,
        ...
        ["idx"] = {10200009, 10201009, 10202009, 10203009, 10204009, 10205009}
    },
    {
        ["itemType"] = 6,
        ["odd"] = 0.045,
    ...
    },
    {
        ...
        ["idx"] = {10210017, 10211017, 10212017, 10213017, 10220009, 10221009, 10222009}
    },
    {
        ["itemType"] = 7,
        ["odd"] = 0.001,
...
function gp_treasuredropper_changbai:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_changbai:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_changbai:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_changbai:OnOpen(selfId, targetId)
end

function gp_treasuredropper_changbai:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_changbai:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_changbai:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_changbai
