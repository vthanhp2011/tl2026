...
local gp_treasuredropper_caoyuan = class("gp_treasuredropper_caoyuan", script_base)
gp_treasuredropper_caoyuan.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_caoyuan.g_TickCreate_Msg = ""
gp_treasuredropper_caoyuan.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.284,
        ["numOdd"] = {
        ...
        ["idx"] = {30001004, 30003007, 30101037}
    },
    {
        ["itemType"] = 2,
        ["odd"] = 0.293,
    ...
    },
    {
        ...
        ["idx"] = {30602007, 30603007, 30604007, 30605007}
    },
    {
        ["itemType"] = 4,
        ["odd"] = 0.1,
    ...
    },
    {
        ...
        ["idx"] = {10100007, 10101007, 10102007, 10103007, 10104007, 10105007}
    },
    {
        ["itemType"] = 10,
        ["odd"] = 0,
        ...
        ["idx"] = {10200007, 10201007, 10202007, 10203007, 10204007, 10205007}
    },
    {
        ["itemType"] = 6,
        ["odd"] = 0.045,
    ...
    },
    {
        ...
        ["idx"] = {10210013, 10211013, 10212013, 10213013, 10220007, 10221007, 10222007}
    },
    {
        ["itemType"] = 7,
        ["odd"] = 0.001,
...
function gp_treasuredropper_caoyuan:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_caoyuan:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_caoyuan:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_caoyuan:OnOpen(selfId, targetId)
end

function gp_treasuredropper_caoyuan:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_caoyuan:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_caoyuan:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_caoyuan
