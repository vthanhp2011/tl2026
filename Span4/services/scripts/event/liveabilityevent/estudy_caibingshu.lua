...
local estudy_caibingshu = class("estudy_caibingshu", script_base)
estudy_caibingshu.script_id = 713532
estudy_caibingshu.g_MessageStudy = "如果你达到%d级并且肯花费#{_EXCHG%d}就可以学会采冰术技能。你决定学习么？"
estudy_caibingshu.g_AbilityID = define.ABILITY_CAIBINGSHU
estudy_caibingshu.g_AbilityName = "采冰术"
function estudy_caibingshu:OnDefaultEvent(selfId, targetId, ButtomNum, g_Npc_ScriptId)
...
function estudy_caibingshu:OnEnumerate(caller, selfId, targetId, bid)
    caller:AddNumTextWithTarget(self.script_id, "学习" .. self.g_AbilityName .. "技能", 12, 0)
end

function estudy_caibingshu:CheckAccept()

end

function estudy_caibingshu:OnAccept()

end

return estudy_caibingshu
