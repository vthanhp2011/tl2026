...
local estudy_zhidu = class("estudy_zhidu", script_base)
estudy_zhidu.script_id = 713517
estudy_zhidu.g_MessageStudy = "如果你达到%d级并且肯花费#{_EXCHG%d}就可以学会制毒技能。你决定学习么？"
estudy_zhidu.g_AbilityID = define.ABILITY_ZHIDU
estudy_zhidu.g_AbilityName = "制毒"
function estudy_zhidu:OnDefaultEvent(selfId, targetId, ButtomNum, g_Npc_ScriptId)
...
function estudy_zhidu:OnEnumerate(caller, selfId, targetId, bid)
    caller:AddNumTextWithTarget(self.script_id, "学习" .. self.g_AbilityName .. "技能", 12, 0)
end

function estudy_zhidu:CheckAccept()

end

function estudy_zhidu:OnAccept()
