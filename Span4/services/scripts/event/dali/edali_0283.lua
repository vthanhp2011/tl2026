...
local edali_0283 = class("edali_0283", script_base)
edali_0283.script_id = 210283
edali_0283.g_busGuilList = {1000003, 1000004}
function edali_0283:OnDefaultEvent(selfId, targetId)
    local bSucceeded = 0
...
function edali_0283:OnEnumerate(caller)
    caller:AddNumTextWithTarget(self.script_id, "飞往南门", 9, -1)
end
