...
local omeiling_chuansong_1 = class("omeiling_chuansong_1", script_base)
omeiling_chuansong_1.script_id = 033030
omeiling_chuansong_1.g_city0 = 214
omeiling_chuansong_1.g_city1 = 232
omeiling_chuansong_1.g_city2 = 606
omeiling_chuansong_1.g_city3 = 624
function omeiling_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function omeiling_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
