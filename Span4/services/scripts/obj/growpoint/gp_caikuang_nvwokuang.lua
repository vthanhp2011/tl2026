...
local gp_caikuang_nvwokuang = class("gp_caikuang_nvwokuang", script_base)
gp_caikuang_nvwokuang.g_MainItemId = 20103012
gp_caikuang_nvwokuang.g_SubItemId = 50101002
gp_caikuang_nvwokuang.g_Byproduct = {20103024, 20103036, 20103048, 20103060}

gp_caikuang_nvwokuang.g_AbilityId = 7
gp_caikuang_nvwokuang.g_AbilityLevel = 12
function gp_caikuang_nvwokuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_nvwokuang:OnOpen(selfId, targetId)
