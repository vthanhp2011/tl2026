...
local gp_caiyao_niuhuang = class("gp_caiyao_niuhuang", script_base)
gp_caiyao_niuhuang.g_MainItemId = 20101021
gp_caiyao_niuhuang.g_SubItemId = 20304012
gp_caiyao_niuhuang.g_AbilityId = 8
gp_caiyao_niuhuang.g_AbilityLevel = 8
function gp_caiyao_niuhuang:OnCreate(growPointType, x, y)
...
function gp_caiyao_niuhuang:OnOpen(selfId, targetId)
