...
local gp_caiyao_huoxiang = class("gp_caiyao_huoxiang", script_base)
gp_caiyao_huoxiang.g_MainItemId = 20101020
gp_caiyao_huoxiang.g_SubItemId = 20304011
gp_caiyao_huoxiang.g_AbilityId = 8
gp_caiyao_huoxiang.g_AbilityLevel = 7
function gp_caiyao_huoxiang:OnCreate(growPointType, x, y)
...
function gp_caiyao_huoxiang:OnOpen(selfId, targetId)
