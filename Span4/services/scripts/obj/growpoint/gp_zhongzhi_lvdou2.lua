...
local gp_zhongzhi_lvdou2 = class("gp_zhongzhi_lvdou2", script_base)
gp_zhongzhi_lvdou2.g_GpId = 523
gp_zhongzhi_lvdou2.g_GpIdNext = 524
function gp_zhongzhi_lvdou2:OnRecycle(selfId, targetId)
    local itemBoxX = self:GetItemBoxWorldPosX(targetId)
    local itemBoxZ = self:GetItemBoxWorldPosZ(targetId)
    local ItemBoxId = self:ItemBoxEnterScene(itemBoxX, itemBoxZ, self.g_GpIdNext, define.QUALITY_MUST_BE_CHANGE, 1, 20104008)
