...
local gp_caiyao_chansu = class("gp_caiyao_chansu", script_base)
gp_caiyao_chansu.g_MainItemId = 20101029
gp_caiyao_chansu.g_SubItemId = 20304015
gp_caiyao_chansu.g_AbilityId = 8
gp_caiyao_chansu.g_AbilityLevel = 11
function gp_caiyao_chansu:OnCreate(growPointType, x, y)
...
function gp_caiyao_chansu:OnOpen(selfId, targetId)
