...
local gp_caikuang_hantiekuang = class("gp_caikuang_hantiekuang", script_base)
gp_caikuang_hantiekuang.g_MainItemId = 20103004
gp_caikuang_hantiekuang.g_SubItemId = 50113003
gp_caikuang_hantiekuang.g_Byproduct = {20103016, 20103028, 20103040, 20103052}

gp_caikuang_hantiekuang.g_AbilityId = 7
gp_caikuang_hantiekuang.g_AbilityLevel = 4
function gp_caikuang_hantiekuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_hantiekuang:OnOpen(selfId, targetId)
...
return gp_caikuang_hantiekuang
