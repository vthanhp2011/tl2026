...
local gp_caiyao_cangshu = class("gp_caiyao_cangshu", script_base)
gp_caiyao_cangshu.g_MainItemId = 20101012
gp_caiyao_cangshu.g_SubItemId = 20304009
gp_caiyao_cangshu.g_AbilityId = 8
gp_caiyao_cangshu.g_AbilityLevel = 5
function gp_caiyao_cangshu:OnCreate(growPointType, x, y)
...
function gp_caiyao_cangshu:OnOpen(selfId, targetId)
