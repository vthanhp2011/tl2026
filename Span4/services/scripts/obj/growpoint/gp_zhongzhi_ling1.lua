...
local gp_zhongzhi_ling1 = class("gp_zhongzhi_ling1", script_base)
gp_zhongzhi_ling1.g_GpId = 558
gp_zhongzhi_ling1.g_GpIdNext = 559
function gp_zhongzhi_ling1:OnRecycle(selfId, targetId)
