...
local gp_zhongzhi_ma3 = class("gp_zhongzhi_ma3", script_base)
gp_zhongzhi_ma3.g_GpId = 539
gp_zhongzhi_ma3.g_ItemBoxNeedLevel = 1
function gp_zhongzhi_ma3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_ma3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_ma3:OnRecycle(selfId, targetId)
    local num = 0
