...
local gp_zhongzhi_miani3 = class("gp_zhongzhi_miani3", script_base)
gp_zhongzhi_miani3.g_GpId = 542
gp_zhongzhi_miani3.g_ItemBoxNeedLevel = 2
function gp_zhongzhi_miani3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_miani3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_miani3:OnRecycle(selfId, targetId)
    local num = 0
