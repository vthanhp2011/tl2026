...
local gp_zhongzhi_si1 = class("gp_zhongzhi_si1", script_base)
gp_zhongzhi_si1.g_GpId = 552
gp_zhongzhi_si1.g_GpIdNext = 553
function gp_zhongzhi_si1:OnRecycle(selfId, targetId)
