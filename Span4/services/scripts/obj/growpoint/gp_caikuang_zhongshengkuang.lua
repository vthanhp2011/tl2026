...
local gp_caikuang_zhongshengkuang = class("gp_caikuang_zhongshengkuang", script_base)
gp_caikuang_zhongshengkuang.g_MainItemId = 20103119
gp_caikuang_zhongshengkuang.g_SubItemId = 50112004
gp_caikuang_zhongshengkuang.g_Byproduct = {20103123, 20103127, 20103131, 20103135}

gp_caikuang_zhongshengkuang.g_AbilityId = 7
gp_caikuang_zhongshengkuang.g_AbilityLevel = 10
function gp_caikuang_zhongshengkuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_zhongshengkuang:OnOpen(selfId, targetId)
...
function gp_caikuang_zhongshengkuang:OnRecycle(selfId, targetId)
    local ABilityID = self:GetItemBoxRequireAbilityID(targetId)
    self:CallScriptFunction(define.ABILITYLOGIC_ID, "GainExperience", selfId, ABilityID, self.g_AbilityLevel)
    return 1
end

function gp_caikuang_zhongshengkuang:OnProcOver(selfId, targetId)
    local ABilityID = self:GetItemBoxRequireAbilityID(targetId)
    self:CallScriptFunction(define.ABILITYLOGIC_ID, "EnergyCostCaiJi", selfId, ABilityID, self.g_AbilityLevel)
    return 0
end

function gp_caikuang_zhongshengkuang:OpenCheck(selfId, AbilityId, AbilityLevel)
...
return gp_caikuang_zhongshengkuang
