...
local gp_zhongzhi_malingshu1 = class("gp_zhongzhi_malingshu1", script_base)
gp_zhongzhi_malingshu1.g_GpId = 531
gp_zhongzhi_malingshu1.g_GpIdNext = 532
function gp_zhongzhi_malingshu1:OnRecycle(selfId, targetId)
