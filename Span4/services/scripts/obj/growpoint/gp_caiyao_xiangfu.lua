...
local gp_caiyao_xiangfu = class("gp_caiyao_xiangfu", script_base)
gp_caiyao_xiangfu.g_MainItemId = 20101019
gp_caiyao_xiangfu.g_SubItemId = 20304011
gp_caiyao_xiangfu.g_AbilityId = 8
gp_caiyao_xiangfu.g_AbilityLevel = 7
function gp_caiyao_xiangfu:OnCreate(growPointType, x, y)
...
function gp_caiyao_xiangfu:OnOpen(selfId, targetId)
