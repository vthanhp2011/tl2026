...
local gp_caikuang_tiekuang = class("gp_caikuang_tiekuang", script_base)
gp_caikuang_tiekuang.g_MainItemId = 20103002
gp_caikuang_tiekuang.g_SubItemId = 50113001
gp_caikuang_tiekuang.g_Byproduct = {20103014, 20103026, 20103038, 20103050}

gp_caikuang_tiekuang.g_AbilityId = 7
gp_caikuang_tiekuang.g_AbilityLevel = 2
function gp_caikuang_tiekuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_tiekuang:OnOpen(selfId, targetId)
