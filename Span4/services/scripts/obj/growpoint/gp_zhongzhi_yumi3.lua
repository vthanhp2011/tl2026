...
local gp_zhongzhi_yumi3 = class("gp_zhongzhi_yumi3", script_base)
gp_zhongzhi_yumi3.g_GpId = 509
gp_zhongzhi_yumi3.g_ItemBoxNeedLevel = 3
function gp_zhongzhi_yumi3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_yumi3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_yumi3:OnRecycle(selfId, targetId)
    local num = 0
