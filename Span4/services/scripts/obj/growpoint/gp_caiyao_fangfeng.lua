...
local gp_caiyao_fangfeng = class("gp_caiyao_fangfeng", script_base)
gp_caiyao_fangfeng.g_MainItemId = 20101014
gp_caiyao_fangfeng.g_SubItemId = 20304009
gp_caiyao_fangfeng.g_AbilityId = 8
gp_caiyao_fangfeng.g_AbilityLevel = 5
function gp_caiyao_fangfeng:OnCreate(growPointType, x, y)
...
function gp_caiyao_fangfeng:OnOpen(selfId, targetId)
