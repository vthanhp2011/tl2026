...
local gp_zhongzhi_malingshu3 = class("gp_zhongzhi_malingshu3", script_base)
gp_zhongzhi_malingshu3.g_GpId = 533
gp_zhongzhi_malingshu3.g_ItemBoxNeedLevel = 11
function gp_zhongzhi_malingshu3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_malingshu3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_malingshu3:OnRecycle(selfId, targetId)
    local num = 0
