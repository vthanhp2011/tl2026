...
local gp_zhongzhi_juan1 = class("gp_zhongzhi_juan1", script_base)
gp_zhongzhi_juan1.g_GpId = 549
gp_zhongzhi_juan1.g_GpIdNext = 550
function gp_zhongzhi_juan1:OnRecycle(selfId, targetId)
