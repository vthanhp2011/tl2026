...
local gp_caikuang_longxuekuang = class("gp_caikuang_longxuekuang", script_base)
gp_caikuang_longxuekuang.g_MainItemId = 20103010
gp_caikuang_longxuekuang.g_SubItemId = 50103001
gp_caikuang_longxuekuang.g_Byproduct = {20103022, 20103034, 20103046, 20103058}

gp_caikuang_longxuekuang.g_AbilityId = 7
gp_caikuang_longxuekuang.g_AbilityLevel = 10
function gp_caikuang_longxuekuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_longxuekuang:OnOpen(selfId, targetId)
...
return gp_caikuang_longxuekuang
