...
local gp_yanwanggumu = class("gp_yanwanggumu", script_base)
gp_yanwanggumu.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 1},
    {["num"] = 2, ["odd"] = 0},
    {["num"] = 3, ["odd"] = 0},
    {["num"] = 4, ["odd"] = 0},
...
gp_yanwanggumu.g_TickCreate_Msg = ""
gp_yanwanggumu.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0,
        ["numOdd"] = {
...
function gp_yanwanggumu:GetTableIndexByOdd(tb)
...
function gp_yanwanggumu:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_yanwanggumu:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_yanwanggumu:OnOpen(selfId, targetId)
end

function gp_yanwanggumu:OnRecycle(selfId, targetId)
    return 1
end

function gp_yanwanggumu:OnProcOver(selfId, targetId)
end

function gp_yanwanggumu:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_yanwanggumu
