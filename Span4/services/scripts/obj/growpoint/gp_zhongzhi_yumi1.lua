...
local gp_zhongzhi_yumi1 = class("gp_zhongzhi_yumi1", script_base)
gp_zhongzhi_yumi1.g_GpId = 507
gp_zhongzhi_yumi1.g_GpIdNext = 508
function gp_zhongzhi_yumi1:OnRecycle(selfId, targetId)
