...
local oyannan_chuansong_1 = class("oyannan_chuansong_1", script_base)
oyannan_chuansong_1.script_id = 018030
oyannan_chuansong_1.g_city0 = 205
oyannan_chuansong_1.g_city1 = 223
oyannan_chuansong_1.g_city2 = 597
oyannan_chuansong_1.g_city3 = 615
function oyannan_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function oyannan_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
