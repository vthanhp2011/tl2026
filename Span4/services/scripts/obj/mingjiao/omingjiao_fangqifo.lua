...
local omingjiao_fangqifo = class("omingjiao_fangqifo", script_base)
omingjiao_fangqifo.script_id = 011003
omingjiao_fangqifo.g_mpInfo = {}

omingjiao_fangqifo.g_mpInfo[0] = {"星宿", 16, 96, 152, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XINGXIU}

omingjiao_fangqifo.g_mpInfo[1] = {"逍遥", 14, 67, 145, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XIAOYAO}

omingjiao_fangqifo.g_mpInfo[2] = {"少林", 9, 95, 137, define.MENPAI_ATTRIBUTE.MATTRIBUTE_SHAOLIN}

omingjiao_fangqifo.g_mpInfo[3] = {"天山", 17, 95, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_TIANSHAN}

omingjiao_fangqifo.g_mpInfo[4] = {"天龙", 13, 96, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_DALI}

omingjiao_fangqifo.g_mpInfo[5] = {"峨嵋", 15, 89, 144, define.MENPAI_ATTRIBUTE.MATTRIBUTE_EMEI}

omingjiao_fangqifo.g_mpInfo[6] = {"武当", 12, 103, 140, define.MENPAI_ATTRIBUTE.MATTRIBUTE_WUDANG}

omingjiao_fangqifo.g_mpInfo[7] = {"明教", 11, 98, 167, define.MENPAI_ATTRIBUTE.MATTRIBUTE_MINGJIAO}

omingjiao_fangqifo.g_mpInfo[8] = {"丐帮", 10, 91, 116, define.MENPAI_ATTRIBUTE.MATTRIBUTE_GAIBANG}

omingjiao_fangqifo.g_xuanWuDaoId = 400918
function omingjiao_fangqifo:OnDefaultEvent(selfId, targetId)
    self:BeginEvent(self.script_id)
    self:AddText("#{MPXL_090113_05}")
...
function omingjiao_fangqifo:OnEventRequest(selfId, targetId, arg, index)
...
function omingjiao_fangqifo:GotoShuHeGuZhen(selfId, targetId)
    self:CallScriptFunction((400900), "TransferFuncFromNpc", selfId, 420, 200, 211, 20)
    return
end

return omingjiao_fangqifo
