...
local item_4637 = class("item_4637", script_base)
item_4637.g_petCommonId = define.PETCOMMON
item_4637.script_id = 334637
item_4637.g_HPValue = 9556
item_4637.g_MaxHPValue = 0
item_4637.g_LifeValue = 0
item_4637.g_HappinessValue = 0
function item_4637:IsSkillLikeScript(selfId)
    return 1
end

function item_4637:OnConditionCheck(selfId)
...
function item_4637:OnDeplete(selfId)
...
function item_4637:OnActivateOnce(selfId)
...
function item_4637:OnActivateEachTick(selfId)
    return 1
end

function item_4637:CancelImpacts(selfId)
    return 0
end
