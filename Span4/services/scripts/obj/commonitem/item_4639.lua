...
local item_4639 = class("item_4639", script_base)
item_4639.g_petCommonId = define.PETCOMMON
item_4639.script_id = 334639
item_4639.g_HPValue = 12372
item_4639.g_MaxHPValue = 0
item_4639.g_LifeValue = 0
item_4639.g_HappinessValue = 0
function item_4639:IsSkillLikeScript(selfId)
    return 1
end

function item_4639:OnConditionCheck(selfId)
...
function item_4639:OnDeplete(selfId)
...
function item_4639:OnActivateOnce(selfId)
...
function item_4639:OnActivateEachTick(selfId)
    return 1
end

function item_4639:CancelImpacts(selfId)
    return 0
end
