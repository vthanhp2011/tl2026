...
local item_4603 = class("item_4603", script_base)
item_4603.g_petCommonId = define.PETCOMMON
item_4603.script_id = 334603
item_4603.g_HPValue = 3924
item_4603.g_MaxHPValue = 0
item_4603.g_LifeValue = 0
item_4603.g_HappinessValue = 0
function item_4603:IsSkillLikeScript(selfId)
    return 1
end

function item_4603:OnConditionCheck(selfId)
...
function item_4603:OnDeplete(selfId)
...
function item_4603:OnActivateOnce(selfId)
...
function item_4603:OnActivateEachTick(selfId)
    return 1
end

function item_4603:CancelImpacts(selfId)
    return 0
end
