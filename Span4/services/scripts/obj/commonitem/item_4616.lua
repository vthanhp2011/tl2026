...
local item_4616 = class("item_4616", script_base)
item_4616.g_petCommonId = define.PETCOMMON
item_4616.script_id = 334616
item_4616.g_HPValue = 8148
item_4616.g_MaxHPValue = 0
item_4616.g_LifeValue = 0
item_4616.g_HappinessValue = 0
function item_4616:IsSkillLikeScript(selfId)
    return 1
end

function item_4616:OnConditionCheck(selfId)
...
function item_4616:OnDeplete(selfId)
...
function item_4616:OnActivateOnce(selfId)
...
function item_4616:OnActivateEachTick(selfId)
    return 1
end

function item_4616:CancelImpacts(selfId)
    return 0
end
