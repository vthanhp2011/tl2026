...
local item_4611 = class("item_4611", script_base)
item_4611.g_petCommonId = define.PETCOMMON
item_4611.script_id = 334611
item_4611.g_HPValue = 1108
item_4611.g_MaxHPValue = 0
item_4611.g_LifeValue = 0
item_4611.g_HappinessValue = 0
function item_4611:IsSkillLikeScript(selfId)
    return 1
end

function item_4611:OnConditionCheck(selfId)
...
function item_4611:OnDeplete(selfId)
...
function item_4611:OnActivateOnce(selfId)
...
function item_4611:OnActivateEachTick(selfId)
    return 1
end

function item_4611:CancelImpacts(selfId)
    return 0
end
