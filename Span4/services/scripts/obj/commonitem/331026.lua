	...
	if(self:LuaFnDepletingUsedItem(selfId)) then
		if szTransferItem and selfName then
			...
			if sceneType and sceneType == 0 then
				...
				curItem.msg2 = gbk.fromutf8(curItem.msg2)
				strMsg = string.format(curItem.msg2, selfName, sceneName, "#{_INFOMSG"..szTransferItem.."}")
			else
				curItem.msg1 = gbk.fromutf8(curItem.msg1)
				strMsg = string.format(gbk.fromutf8(curItem.msg1, selfName, "#{_INFOMSG"..szTransferItem.."}"))
			end
