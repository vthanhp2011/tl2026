...
local item_4619 = class("item_4619", script_base)
item_4619.g_petCommonId = define.PETCOMMON
item_4619.script_id = 334619
item_4619.g_HPValue = 12372
item_4619.g_MaxHPValue = 0
item_4619.g_LifeValue = 0
item_4619.g_HappinessValue = 0
function item_4619:IsSkillLikeScript(selfId)
    return 1
end

function item_4619:OnConditionCheck(selfId)
...
function item_4619:OnDeplete(selfId)
...
function item_4619:OnActivateOnce(selfId)
...
function item_4619:OnActivateEachTick(selfId)
    return 1
end

function item_4619:CancelImpacts(selfId)
    return 0
end
