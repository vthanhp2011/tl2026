...
local item_4605 = class("item_4605", script_base)
item_4605.g_petCommonId = define.PETCOMMON
item_4605.script_id = 334605
item_4605.g_HPValue = 6740
item_4605.g_MaxHPValue = 0
item_4605.g_LifeValue = 0
item_4605.g_HappinessValue = 0
function item_4605:IsSkillLikeScript(selfId)
    return 1
end

function item_4605:OnConditionCheck(selfId)
...
function item_4605:OnDeplete(selfId)
...
function item_4605:OnActivateOnce(selfId)
...
function item_4605:OnActivateEachTick(selfId)
    return 1
end

function item_4605:CancelImpacts(selfId)
    return 0
end
