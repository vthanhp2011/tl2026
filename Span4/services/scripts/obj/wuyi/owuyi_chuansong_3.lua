...
local owuyi_chuansong_3 = class("owuyi_chuansong_3", script_base)
owuyi_chuansong_3.script_id = 032032
owuyi_chuansong_3.g_city0 = 285
owuyi_chuansong_3.g_city1 = 303
owuyi_chuansong_3.g_city2 = 677
owuyi_chuansong_3.g_city3 = 695
function owuyi_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function owuyi_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
