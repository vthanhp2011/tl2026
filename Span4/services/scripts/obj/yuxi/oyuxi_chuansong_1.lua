...
local oyuxi_chuansong_1 = class("oyuxi_chuansong_1", script_base)
oyuxi_chuansong_1.script_id = 027030
oyuxi_chuansong_1.g_city0 = 216
oyuxi_chuansong_1.g_city1 = 234
oyuxi_chuansong_1.g_city2 = 608
oyuxi_chuansong_1.g_city3 = 626
function oyuxi_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function oyuxi_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
