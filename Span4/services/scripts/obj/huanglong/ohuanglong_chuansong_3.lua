...
local ohuanglong_chuansong_3 = class("ohuanglong_chuansong_3", script_base)
ohuanglong_chuansong_3.script_id = 023032
ohuanglong_chuansong_3.g_city0 = 290
ohuanglong_chuansong_3.g_city1 = 308
ohuanglong_chuansong_3.g_city2 = 682
ohuanglong_chuansong_3.g_city3 = 700
function ohuanglong_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function ohuanglong_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
