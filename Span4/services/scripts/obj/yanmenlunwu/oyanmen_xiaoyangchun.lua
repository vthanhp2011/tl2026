...
local oyanmen_xiaoyangchun = class("oyanmen_xiaoyangchun", script_base)
oyanmen_xiaoyangchun.ID = {49908,49909,49910,49911,49912,49913}
oyanmen_xiaoyangchun.Title = 4
oyanmen_xiaoyangchun.script_id = 893135
oyanmen_xiaoyangchun.g_FuBenScriptId = 893131
oyanmen_xiaoyangchun.g_MonsterAI = 893144
function oyanmen_xiaoyangchun:OnDefaultEvent(selfId,targetId)
	self:BeginEvent(self.script_id)
		self:AddText("#{MPCG_191029_139}")
		self:AddNumText("#{MPCG_191029_24}",10,1)
	self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end

function oyanmen_xiaoyangchun:OnEventRequest(selfId,targetId,arg,index)
...
function oyanmen_xiaoyangchun:MsgBox(selfId,targetId,str)
	self:BeginEvent(self.script_id)
		self:AddText(str)
		self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end
return oyanmen_xiaoyangchun