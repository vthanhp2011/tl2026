...
local oyanmen_jitianran = class("oyanmen_jitianran", script_base)
oyanmen_jitianran.ID = {49894,49895,49896,49897,49898,49899}
oyanmen_jitianran.Title = 2
oyanmen_jitianran.script_id = 893133
oyanmen_jitianran.g_FuBenScriptId = 893131
oyanmen_jitianran.g_MonsterAI = 893142
function oyanmen_jitianran:OnDefaultEvent(selfId,targetId)
	self:BeginEvent(self.script_id)
		self:AddText("#{MPCG_191029_137}")
		self:AddNumText("#{MPCG_191029_24}",10,1)
	self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end

function oyanmen_jitianran:OnEventRequest(selfId,targetId,arg,index)
...
function oyanmen_jitianran:MsgBox(selfId,targetId,str)
	self:BeginEvent(self.script_id)
		self:AddText(str)
		self:EndEvent()
	self:DispatchEventList(selfId,targetId)
end
return oyanmen_jitianran