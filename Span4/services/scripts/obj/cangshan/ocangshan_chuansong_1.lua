...
local ocangshan_chuansong_1 = class("ocangshan_chuansong_1", script_base)
ocangshan_chuansong_1.script_id = 025030
ocangshan_chuansong_1.g_city0 = 209
ocangshan_chuansong_1.g_city1 = 227
ocangshan_chuansong_1.g_city2 = 601
ocangshan_chuansong_1.g_city3 = 619
function ocangshan_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function ocangshan_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
