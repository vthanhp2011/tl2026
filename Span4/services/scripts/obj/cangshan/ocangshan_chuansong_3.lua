...
local ocangshan_chuansong_3 = class("ocangshan_chuansong_3", script_base)
ocangshan_chuansong_3.script_id = 025032
ocangshan_chuansong_3.g_city0 = 281
ocangshan_chuansong_3.g_city1 = 299
ocangshan_chuansong_3.g_city2 = 673
ocangshan_chuansong_3.g_city3 = 691
function ocangshan_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function ocangshan_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
