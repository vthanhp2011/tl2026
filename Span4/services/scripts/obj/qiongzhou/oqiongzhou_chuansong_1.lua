...
local oqiongzhou_chuansong_1 = class("oqiongzhou_chuansong_1", script_base)
oqiongzhou_chuansong_1.script_id = 035030
oqiongzhou_chuansong_1.g_city0 = 220
oqiongzhou_chuansong_1.g_city1 = 238
oqiongzhou_chuansong_1.g_city2 = 612
oqiongzhou_chuansong_1.g_city3 = 630
function oqiongzhou_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function oqiongzhou_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
