...
local oerhai_chuansong_3 = class("oerhai_chuansong_3", script_base)
oerhai_chuansong_3.script_id = 024032
oerhai_chuansong_3.g_city0 = 282
oerhai_chuansong_3.g_city1 = 300
oerhai_chuansong_3.g_city2 = 674
oerhai_chuansong_3.g_city3 = 692
function oerhai_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function oerhai_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
