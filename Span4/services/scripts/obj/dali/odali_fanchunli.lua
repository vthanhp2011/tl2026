...
local odali_fanchunli = class("odali_fanchunli", script_base)
odali_fanchunli.script_id = 002093
odali_fanchunli.g_eventList = {600000}

function odali_fanchunli:OnDefaultEvent(selfId, targetId)
...
function odali_fanchunli:OnEventRequest(selfId, targetId, arg, index)
    if index == 10 then
        self:BeginEvent(self.script_id)
