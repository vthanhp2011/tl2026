...
local omiaojiang_chuansong_1 = class("omiaojiang_chuansong_1", script_base)
omiaojiang_chuansong_1.script_id = 029030
omiaojiang_chuansong_1.g_city0 = 222
omiaojiang_chuansong_1.g_city1 = 240
omiaojiang_chuansong_1.g_city2 = 614
omiaojiang_chuansong_1.g_city3 = 632
function omiaojiang_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function omiaojiang_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
