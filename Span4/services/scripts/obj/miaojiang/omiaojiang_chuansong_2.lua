...
local omiaojiang_chuansong_2 = class("omiaojiang_chuansong_2", script_base)
omiaojiang_chuansong_2.script_id = 029031
omiaojiang_chuansong_2.g_city0 = 258
omiaojiang_chuansong_2.g_city1 = 276
omiaojiang_chuansong_2.g_city2 = 650
omiaojiang_chuansong_2.g_city3 = 668
function omiaojiang_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function omiaojiang_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
