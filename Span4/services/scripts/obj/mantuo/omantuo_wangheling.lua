...
local omantuo_wangheling = class("omantuo_wangheling", script_base)

function omantuo_wangheling:OnDefaultEvent(selfId, targetId)
...
function omantuo_wangheling:OnEventRequest(selfId, targetId, arg, index)
    if index == 10 then
        self:BeginEvent(self.script_id)
