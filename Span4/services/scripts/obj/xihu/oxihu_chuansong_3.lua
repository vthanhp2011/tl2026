...
local oxihu_chuansong_3 = class("oxihu_chuansong_3", script_base)
oxihu_chuansong_3.script_id = 030032
oxihu_chuansong_3.g_city0 = 279
oxihu_chuansong_3.g_city1 = 297
oxihu_chuansong_3.g_city2 = 671
oxihu_chuansong_3.g_city3 = 689
function oxihu_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function oxihu_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
