...
local std_talent_171 = class("std_talent_171", base)
function std_talent_171:is_specific_skill_id(skill_id)
    return skill_id == 501
end

function std_talent_171:get_refix_value(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_171:refix_skill_cool_down_time(talent, level, talent_id, skill_info, cool_down_time)
