...
local std_talent_305 = class("std_talent_305", base)
local DI_DamagesByValue_T = require "scene.skill.impact_logic.std_impact_003"
local DAMAGE_TYPE_RATE = DI_DamagesByValue_T.enum_DAMAGE_TYPE_RATE

function std_talent_305:get_refix_percent(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_305:on_damages(talent, level, damages, obj_me, caster_obj_id, is_critical)
    if obj_me:impact_have_impact_of_specific_impact_id(3865) then
