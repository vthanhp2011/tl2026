...
local std_talent_186 = class("std_talent_186", base)

function std_talent_186:is_specific_skill(skill_id)
    return skill_id == 535
end

function std_talent_186:get_refix_value(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_186:refix_skill_info(talent, level, skill_info, human)
