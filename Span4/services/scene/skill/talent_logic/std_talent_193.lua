...
local std_talent_193 = class("std_talent_193", base)
function std_talent_193:is_specific_skill_id(skill_id)
    return skill_id == 525
end

function std_talent_193:get_refix_value(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_193:refix_skill_cool_down_time(talent, level, talent_id, skill_info, cool_down_time)
