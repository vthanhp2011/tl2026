...
local std_talent_183 = class("std_talent_183", base)
function std_talent_183:is_specific_skill(skill_id)
    return skill_id == 523
end

function std_talent_183:get_odd(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_183:on_hit_target(talent, level, sender, reciver, skill_id)
