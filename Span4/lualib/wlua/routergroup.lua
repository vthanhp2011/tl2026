...
local util_file = require "file_util"
...
function M:static_dir(relative_path, static_path)
    local function static_dir_handler(c)
        skynet.logd("static_dir_handler. c.params:", util_json.encode(c.params))
