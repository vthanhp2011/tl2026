...
namespace NavMesh {
	...
	std::vector<Point> PathFinder::GetPath(const Point& start_coord, const Point& dest_coord)
	{
		...
		printf("PathFinder::GetPath start = %d, dest = %d, start_coord.x = %d, start_coord.y = %d, dest_coord.x = %d, dest_coord = %d\n", start, dest, start_coord.x, start_coord.y, dest_coord.x, dest_coord.y);
