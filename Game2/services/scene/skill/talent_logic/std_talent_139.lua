...
local std_talent_139 = class("std_talent_139", base)
function std_talent_139:is_specific_skill(skill_id)
    return skill_id == 463
end

function std_talent_139:get_odd(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_139:on_hit_target(talent, level, sender, reciver, skill_id)
