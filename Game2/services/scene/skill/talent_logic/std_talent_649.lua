...
local std_talent_649 = class("std_talent_649", base)
function std_talent_649:is_specific_skill(skill_id)
    return skill_id == 788
end

function std_talent_649:get_refix_value(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_649:on_hit_target(talent, level, sender, reciver, skill_id)
