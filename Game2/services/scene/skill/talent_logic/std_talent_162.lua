...
local std_talent_162 = class("std_talent_162", base)
function std_talent_162:is_specific_skill(skill_id)
    return skill_id == 493
end

function std_talent_162:get_odd(talent, level)
    local params = talent.params[level]
    return params[1] or 0
end

function std_talent_162:on_hit_target(talent, level, sender, reciver, skill_id)
