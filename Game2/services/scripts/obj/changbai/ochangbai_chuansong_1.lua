...
local ochangbai_chuansong_1 = class("ochangbai_chuansong_1", script_base)
ochangbai_chuansong_1.script_id = 022030
ochangbai_chuansong_1.g_city0 = 217
ochangbai_chuansong_1.g_city1 = 235
ochangbai_chuansong_1.g_city2 = 609
ochangbai_chuansong_1.g_city3 = 627
function ochangbai_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function ochangbai_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
