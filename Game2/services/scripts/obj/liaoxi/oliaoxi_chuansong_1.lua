...
local oliaoxi_chuansong_1 = class("oliaoxi_chuansong_1", script_base)
oliaoxi_chuansong_1.script_id = 021030
oliaoxi_chuansong_1.g_city0 = 212
oliaoxi_chuansong_1.g_city1 = 230
oliaoxi_chuansong_1.g_city2 = 604
oliaoxi_chuansong_1.g_city3 = 622
function oliaoxi_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function oliaoxi_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
