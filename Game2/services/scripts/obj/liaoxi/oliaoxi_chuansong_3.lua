...
local oliaoxi_chuansong_3 = class("oliaoxi_chuansong_3", script_base)
oliaoxi_chuansong_3.script_id = 021032
oliaoxi_chuansong_3.g_city0 = 284
oliaoxi_chuansong_3.g_city1 = 302
oliaoxi_chuansong_3.g_city2 = 676
oliaoxi_chuansong_3.g_city3 = 694
function oliaoxi_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function oliaoxi_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
