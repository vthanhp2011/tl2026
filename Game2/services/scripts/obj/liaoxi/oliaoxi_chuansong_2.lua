...
local oliaoxi_chuansong_2 = class("oliaoxi_chuansong_2", script_base)
oliaoxi_chuansong_2.script_id = 021031
oliaoxi_chuansong_2.g_city0 = 248
oliaoxi_chuansong_2.g_city1 = 266
oliaoxi_chuansong_2.g_city2 = 640
oliaoxi_chuansong_2.g_city3 = 658
function oliaoxi_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function oliaoxi_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
