...
local oshilin_chuansong_1 = class("oshilin_chuansong_1", script_base)
oshilin_chuansong_1.script_id = 026030
oshilin_chuansong_1.g_city0 = 215
oshilin_chuansong_1.g_city1 = 233
oshilin_chuansong_1.g_city2 = 607
oshilin_chuansong_1.g_city3 = 625
function oshilin_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function oshilin_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
