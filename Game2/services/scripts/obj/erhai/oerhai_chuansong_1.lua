...
local oerhai_chuansong_1 = class("oerhai_chuansong_1", script_base)
oerhai_chuansong_1.script_id = 024030
oerhai_chuansong_1.g_city0 = 210
oerhai_chuansong_1.g_city1 = 228
oerhai_chuansong_1.g_city2 = 602
oerhai_chuansong_1.g_city3 = 620
function oerhai_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function oerhai_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
