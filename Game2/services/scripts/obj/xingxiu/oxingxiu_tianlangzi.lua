...
local oxingxiu_tianlangzi = class("oxingxiu_tianlangzi", script_base)
oxingxiu_tianlangzi.script_id = 016006
oxingxiu_tianlangzi.g_xuanWuDaoId = 400918
oxingxiu_tianlangzi.g_mpInfo = {}

oxingxiu_tianlangzi.g_mpInfo[0] = {"星宿", 16, 96, 152, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XINGXIU}

oxingxiu_tianlangzi.g_mpInfo[1] = {"逍遥", 14, 67, 145, define.MENPAI_ATTRIBUTE.MATTRIBUTE_XIAOYAO}

oxingxiu_tianlangzi.g_mpInfo[2] = {"少林", 9, 95, 137, define.MENPAI_ATTRIBUTE.MATTRIBUTE_SHAOLIN}

oxingxiu_tianlangzi.g_mpInfo[3] = {"天山", 17, 95, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_TIANSHAN}

oxingxiu_tianlangzi.g_mpInfo[4] = {"天龙", 13, 96, 120, define.MENPAI_ATTRIBUTE.MATTRIBUTE_DALI}

oxingxiu_tianlangzi.g_mpInfo[5] = {"峨嵋", 15, 89, 144, define.MENPAI_ATTRIBUTE.MATTRIBUTE_EMEI}

oxingxiu_tianlangzi.g_mpInfo[6] = {"武当", 12, 103, 140, define.MENPAI_ATTRIBUTE.MATTRIBUTE_WUDANG}

oxingxiu_tianlangzi.g_mpInfo[7] = {"明教", 11, 98, 167, define.MENPAI_ATTRIBUTE.MATTRIBUTE_MINGJIAO}

oxingxiu_tianlangzi.g_mpInfo[8] = {"丐帮", 10, 91, 116, define.MENPAI_ATTRIBUTE.MATTRIBUTE_GAIBANG}

function oxingxiu_tianlangzi:OnDefaultEvent(selfId, targetId)
    self:BeginEvent(self.script_id)
    self:AddText("#{OBJ_xingxiu_0002}")
...
function oxingxiu_tianlangzi:OnEventRequest(selfId, targetId, arg, index)
...
function oxingxiu_tianlangzi:GotoShuHeGuZhen(selfId, targetId)
    self:CallScriptFunction((400900), "TransferFuncFromNpc", selfId, 420, 200, 211, 20)
    return
end

return oxingxiu_tianlangzi
