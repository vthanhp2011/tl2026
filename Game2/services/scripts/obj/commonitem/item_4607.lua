...
local item_4607 = class("item_4607", script_base)
item_4607.g_petCommonId = define.PETCOMMON
item_4607.script_id = 334607
item_4607.g_HPValue = 9556
item_4607.g_MaxHPValue = 0
item_4607.g_LifeValue = 0
item_4607.g_HappinessValue = 0
function item_4607:IsSkillLikeScript(selfId)
    return 1
end

function item_4607:OnConditionCheck(selfId)
...
function item_4607:OnDeplete(selfId)
...
function item_4607:OnActivateOnce(selfId)
...
function item_4607:OnActivateEachTick(selfId)
    return 1
end

function item_4607:CancelImpacts(selfId)
    return 0
end
