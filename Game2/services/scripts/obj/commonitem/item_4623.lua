...
local item_4623 = class("item_4623", script_base)
item_4623.g_petCommonId = define.PETCOMMON
item_4623.script_id = 334623
item_4623.g_HPValue = 3924
item_4623.g_MaxHPValue = 0
item_4623.g_LifeValue = 0
item_4623.g_HappinessValue = 0
function item_4623:IsSkillLikeScript(selfId)
    return 1
end

function item_4623:OnConditionCheck(selfId)
...
function item_4623:OnDeplete(selfId)
...
function item_4623:OnActivateOnce(selfId)
...
function item_4623:OnActivateEachTick(selfId)
    return 1
end

function item_4623:CancelImpacts(selfId)
    return 0
end
