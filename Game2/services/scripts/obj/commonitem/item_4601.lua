...
local item_4601 = class("item_4601", script_base)
item_4601.g_petCommonId = define.PETCOMMON
item_4601.script_id = 334601
item_4601.g_HPValue = 1108
item_4601.g_MaxHPValue = 0
item_4601.g_LifeValue = 0
item_4601.g_HappinessValue = 0
function item_4601:IsSkillLikeScript(selfId)
    return 1
end

function item_4601:OnConditionCheck(selfId)
...
function item_4601:OnDeplete(selfId)
...
function item_4601:OnActivateOnce(selfId)
...
function item_4601:OnActivateEachTick(selfId)
    return 1
end

function item_4601:CancelImpacts(selfId)
    return 0
end
