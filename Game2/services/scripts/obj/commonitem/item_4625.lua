...
local item_4625 = class("item_4625", script_base)
item_4625.g_petCommonId = define.PETCOMMON
item_4625.script_id = 334625
item_4625.g_HPValue = 6740
item_4625.g_MaxHPValue = 0
item_4625.g_LifeValue = 0
item_4625.g_HappinessValue = 0
function item_4625:IsSkillLikeScript(selfId)
    return 1
end

function item_4625:OnConditionCheck(selfId)
...
function item_4625:OnDeplete(selfId)
...
function item_4625:OnActivateOnce(selfId)
...
function item_4625:OnActivateEachTick(selfId)
    return 1
end

function item_4625:CancelImpacts(selfId)
    return 0
end
