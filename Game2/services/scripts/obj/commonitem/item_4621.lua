...
local item_4621 = class("item_4621", script_base)
item_4621.g_petCommonId = define.PETCOMMON
item_4621.script_id = 334621
item_4621.g_HPValue = 1108
item_4621.g_MaxHPValue = 0
item_4621.g_LifeValue = 0
item_4621.g_HappinessValue = 0
function item_4621:IsSkillLikeScript(selfId)
    return 1
end

function item_4621:OnConditionCheck(selfId)
...
function item_4621:OnDeplete(selfId)
...
function item_4621:OnActivateOnce(selfId)
...
function item_4621:OnActivateEachTick(selfId)
    return 1
end

function item_4621:CancelImpacts(selfId)
    return 0
end
