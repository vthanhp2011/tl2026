...
local item_4634 = class("item_4634", script_base)
item_4634.g_petCommonId = define.PETCOMMON
item_4634.script_id = 334634
item_4634.g_HPValue = 5332
item_4634.g_MaxHPValue = 0
item_4634.g_LifeValue = 0
item_4634.g_HappinessValue = 0
function item_4634:IsSkillLikeScript(selfId)
    return 1
end

function item_4634:OnConditionCheck(selfId)
...
function item_4634:OnDeplete(selfId)
...
function item_4634:OnActivateOnce(selfId)
...
function item_4634:OnActivateEachTick(selfId)
    return 1
end

function item_4634:CancelImpacts(selfId)
    return 0
end
