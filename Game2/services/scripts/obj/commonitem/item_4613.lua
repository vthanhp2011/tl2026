...
local item_4613 = class("item_4613", script_base)
item_4613.g_petCommonId = define.PETCOMMON
item_4613.script_id = 334613
item_4613.g_HPValue = 3924
item_4613.g_MaxHPValue = 0
item_4613.g_LifeValue = 0
item_4613.g_HappinessValue = 0
function item_4613:IsSkillLikeScript(selfId)
    return 1
end

function item_4613:OnConditionCheck(selfId)
...
function item_4613:OnDeplete(selfId)
...
function item_4613:OnActivateOnce(selfId)
...
function item_4613:OnActivateEachTick(selfId)
    return 1
end

function item_4613:CancelImpacts(selfId)
    return 0
end
