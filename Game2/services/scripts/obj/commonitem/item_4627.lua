...
local item_4627 = class("item_4627", script_base)
item_4627.g_petCommonId = define.PETCOMMON
item_4627.script_id = 334627
item_4627.g_HPValue = 9556
item_4627.g_MaxHPValue = 0
item_4627.g_LifeValue = 0
item_4627.g_HappinessValue = 0
function item_4627:IsSkillLikeScript(selfId)
    return 1
end

function item_4627:OnConditionCheck(selfId)
...
function item_4627:OnDeplete(selfId)
...
function item_4627:OnActivateOnce(selfId)
...
function item_4627:OnActivateEachTick(selfId)
    return 1
end

function item_4627:CancelImpacts(selfId)
    return 0
end
