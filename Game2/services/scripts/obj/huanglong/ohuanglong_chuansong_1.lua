...
local ohuanglong_chuansong_1 = class("ohuanglong_chuansong_1", script_base)
ohuanglong_chuansong_1.script_id = 023030
ohuanglong_chuansong_1.g_city0 = 218
ohuanglong_chuansong_1.g_city1 = 236
ohuanglong_chuansong_1.g_city2 = 610
ohuanglong_chuansong_1.g_city3 = 628
function ohuanglong_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function ohuanglong_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
