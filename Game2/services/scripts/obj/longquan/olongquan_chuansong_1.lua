...
local olongquan_chuansong_1 = class("olongquan_chuansong_1", script_base)
olongquan_chuansong_1.script_id = 031030
olongquan_chuansong_1.g_city0 = 208
olongquan_chuansong_1.g_city1 = 226
olongquan_chuansong_1.g_city2 = 600
olongquan_chuansong_1.g_city3 = 618
function olongquan_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function olongquan_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
