...
local olongquan_chuansong_3 = class("olongquan_chuansong_3", script_base)
olongquan_chuansong_3.script_id = 031032
olongquan_chuansong_3.g_city0 = 280
olongquan_chuansong_3.g_city1 = 298
olongquan_chuansong_3.g_city2 = 672
olongquan_chuansong_3.g_city3 = 690
function olongquan_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function olongquan_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
