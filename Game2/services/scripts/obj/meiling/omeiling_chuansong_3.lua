...
local omeiling_chuansong_3 = class("omeiling_chuansong_3", script_base)
omeiling_chuansong_3.script_id = 033032
omeiling_chuansong_3.g_city0 = 286
omeiling_chuansong_3.g_city1 = 304
omeiling_chuansong_3.g_city2 = 678
omeiling_chuansong_3.g_city3 = 696
function omeiling_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function omeiling_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
