...
local gp_caiyao_dongchongxiacao = class("gp_caiyao_dongchongxiacao", script_base)
gp_caiyao_dongchongxiacao.g_MainItemId = 20101023
gp_caiyao_dongchongxiacao.g_SubItemId = 20304013
gp_caiyao_dongchongxiacao.g_AbilityId = 8
gp_caiyao_dongchongxiacao.g_AbilityLevel = 9
function gp_caiyao_dongchongxiacao:OnCreate(growPointType, x, y)
...
function gp_caiyao_dongchongxiacao:OnOpen(selfId, targetId)
...
return gp_caiyao_dongchongxiacao
