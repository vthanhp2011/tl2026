...
local gp_caikuang_jinkuang = class("gp_caikuang_jinkuang", script_base)
gp_caikuang_jinkuang.g_MainItemId = 20103005
gp_caikuang_jinkuang.g_SubItemId = 50113004
gp_caikuang_jinkuang.g_Byproduct = {20103017, 20103029, 20103041, 20103053}

gp_caikuang_jinkuang.g_AbilityId = 7
gp_caikuang_jinkuang.g_AbilityLevel = 5
function gp_caikuang_jinkuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_jinkuang:OnOpen(selfId, targetId)
