...
local gp_treasuredropper_huanglong = class("gp_treasuredropper_huanglong", script_base)
gp_treasuredropper_huanglong.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_huanglong.g_TickCreate_Msg = ""
gp_treasuredropper_huanglong.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.284,
        ["numOdd"] = {
...
function gp_treasuredropper_huanglong:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_huanglong:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_huanglong:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_huanglong:OnOpen(selfId, targetId)
end

function gp_treasuredropper_huanglong:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_huanglong:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_huanglong:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_huanglong
