...
local gp_zhongzhi_rong3 = class("gp_zhongzhi_rong3", script_base)
gp_zhongzhi_rong3.g_GpId = 566
gp_zhongzhi_rong3.g_ItemBoxNeedLevel = 10
function gp_zhongzhi_rong3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_rong3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_rong3:OnRecycle(selfId, targetId)
    local num = 0
