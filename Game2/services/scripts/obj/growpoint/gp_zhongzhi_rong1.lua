...
local gp_zhongzhi_rong1 = class("gp_zhongzhi_rong1", script_base)
gp_zhongzhi_rong1.g_GpId = 564
gp_zhongzhi_rong1.g_GpIdNext = 565
function gp_zhongzhi_rong1:OnRecycle(selfId, targetId)
