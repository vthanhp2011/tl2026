...
local gp_zhongzhi_sha1 = class("gp_zhongzhi_sha1", script_base)
gp_zhongzhi_sha1.g_GpId = 567
gp_zhongzhi_sha1.g_GpIdNext = 568
function gp_zhongzhi_sha1:OnRecycle(selfId, targetId)
