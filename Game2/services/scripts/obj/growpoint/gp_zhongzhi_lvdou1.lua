...
local gp_zhongzhi_lvdou1 = class("gp_zhongzhi_lvdou1", script_base)
gp_zhongzhi_lvdou1.g_GpId = 522
gp_zhongzhi_lvdou1.g_GpIdNext = 523
function gp_zhongzhi_lvdou1:OnRecycle(selfId, targetId)
