...
local gp_treasuredropper_huoyanshan = class("gp_treasuredropper_huoyanshan", script_base)
gp_treasuredropper_huoyanshan.g_DropNumTable = {
    {["num"] = 1, ["odd"] = 0.2},
    {["num"] = 2, ["odd"] = 0.4},
    {["num"] = 3, ["odd"] = 0.2},
    {["num"] = 4, ["odd"] = 0.15},
...
gp_treasuredropper_huoyanshan.g_TickCreate_Msg = ""
gp_treasuredropper_huoyanshan.g_DropTable = {
    {
        ["itemType"] = 1,
        ["odd"] = 0.284,
        ["numOdd"] = {
        ...
        ["idx"] = {30001019, 30003030, 30101124}
    },
    {
        ["itemType"] = 2,
        ["odd"] = 0.293,
    ...
    },
    {
        ...
        ["idx"] = {20101017, 20101019, 20102007, 20102019, 20103007, 20104007, 20105007}
    },
    {
        ["itemType"] = 12,
        ["odd"] = 0.02,
...
function gp_treasuredropper_huoyanshan:GetTableIndexByOdd(tb)
...
function gp_treasuredropper_huoyanshan:OnCreate(growPointType, x, y, dur)
    local ItemBoxId = nil
...
function gp_treasuredropper_huoyanshan:OnTickCreateFinish(growPointType, tickCount)
    local sceneId = self:get_scene():get_id()
...
function gp_treasuredropper_huoyanshan:OnOpen(selfId, targetId)
end

function gp_treasuredropper_huoyanshan:OnRecycle(selfId, targetId)
    return 1
end

function gp_treasuredropper_huoyanshan:OnProcOver(selfId, targetId)
end

function gp_treasuredropper_huoyanshan:OpenCheck(selfId, AbilityId, AblityLevel)
    return define.OPERATE_RESULT.OR_OK
end

return gp_treasuredropper_huoyanshan
