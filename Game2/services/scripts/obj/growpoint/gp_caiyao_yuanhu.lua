...
local gp_caiyao_yuanhu = class("gp_caiyao_yuanhu", script_base)
gp_caiyao_yuanhu.g_MainItemId = 20101004
gp_caiyao_yuanhu.g_SubItemId = 20304006
gp_caiyao_yuanhu.g_AbilityId = 8
gp_caiyao_yuanhu.g_AbilityLevel = 2
function gp_caiyao_yuanhu:OnCreate(growPointType, x, y)
...
function gp_caiyao_yuanhu:OnOpen(selfId, targetId)
