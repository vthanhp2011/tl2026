...
local gp_zhongzhi_hongshu3 = class("gp_zhongzhi_hongshu3", script_base)
gp_zhongzhi_hongshu3.g_GpId = 515
gp_zhongzhi_hongshu3.g_ItemBoxNeedLevel = 5
function gp_zhongzhi_hongshu3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_hongshu3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_hongshu3:OnRecycle(selfId, targetId)
    local num = 0
