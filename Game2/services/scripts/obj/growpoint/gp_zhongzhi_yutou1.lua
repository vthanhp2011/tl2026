...
local gp_zhongzhi_yutou1 = class("gp_zhongzhi_yutou1", script_base)
gp_zhongzhi_yutou1.g_GpId = 534
gp_zhongzhi_yutou1.g_GpIdNext = 535
function gp_zhongzhi_yutou1:OnRecycle(selfId, targetId)
