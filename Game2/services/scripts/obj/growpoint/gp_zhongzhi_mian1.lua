...
local gp_zhongzhi_mian1 = class("gp_zhongzhi_mian1", script_base)
gp_zhongzhi_mian1.g_GpId = 540
gp_zhongzhi_mian1.g_GpIdNext = 541
function gp_zhongzhi_mian1:OnRecycle(selfId, targetId)
