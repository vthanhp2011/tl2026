...
local gp_zhongzhi_zhima2 = class("gp_zhongzhi_zhima2", script_base)
gp_zhongzhi_zhima2.g_GpId = 520
gp_zhongzhi_zhima2.g_GpIdNext = 521
function gp_zhongzhi_zhima2:OnRecycle(selfId, targetId)
    local itemBoxX = self:GetItemBoxWorldPosX(targetId)
    local itemBoxZ = self:GetItemBoxWorldPosZ(targetId)
    local ItemBoxId = self:ItemBoxEnterScene(itemBoxX, itemBoxZ, self.g_GpIdNext, define.QUALITY_MUST_BE_CHANGE, 1, 20104007)
