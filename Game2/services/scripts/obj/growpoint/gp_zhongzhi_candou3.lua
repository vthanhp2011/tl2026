...
local gp_zhongzhi_candou3 = class("gp_zhongzhi_candou3", script_base)
gp_zhongzhi_candou3.g_GpId = 530
gp_zhongzhi_candou3.g_ItemBoxNeedLevel = 10
function gp_zhongzhi_candou3:OnOpen(selfId, targetId)
...
function gp_zhongzhi_candou3:OnProcOver(selfId, targetId)
    return define.OPERATE_RESULT.OR_OK
end

function gp_zhongzhi_candou3:OnRecycle(selfId, targetId)
    local num = 0
