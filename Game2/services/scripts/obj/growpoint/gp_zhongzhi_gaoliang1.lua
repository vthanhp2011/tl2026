...
local gp_zhongzhi_gaoliang1 = class("gp_zhongzhi_gaoliang1", script_base)
gp_zhongzhi_gaoliang1.g_GpId = 516
gp_zhongzhi_gaoliang1.g_GpIdNext = 517
function gp_zhongzhi_gaoliang1:OnRecycle(selfId, targetId)
