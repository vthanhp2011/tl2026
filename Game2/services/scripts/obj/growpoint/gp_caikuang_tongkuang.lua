...
local gp_caikuang_tongkuang = class("gp_caikuang_tongkuang", script_base)
gp_caikuang_tongkuang.g_MainItemId = 20103001
gp_caikuang_tongkuang.g_SubItemId = 50113005
gp_caikuang_tongkuang.g_Byproduct = {20103013, 20103025, 20103037, 20103049}

gp_caikuang_tongkuang.g_AbilityId = 7
gp_caikuang_tongkuang.g_AbilityLevel = 1
function gp_caikuang_tongkuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_tongkuang:OnOpen(selfId, targetId)
