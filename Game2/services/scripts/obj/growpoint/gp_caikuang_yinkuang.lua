...
local gp_caikuang_yinkuang = class("gp_caikuang_yinkuang", script_base)
gp_caikuang_yinkuang.g_MainItemId = 20103003
gp_caikuang_yinkuang.g_SubItemId = 50113002
gp_caikuang_yinkuang.g_Byproduct = {20103015, 20103027, 20103039, 20103051}

gp_caikuang_yinkuang.g_AbilityId = 7
gp_caikuang_yinkuang.g_AbilityLevel = 3
function gp_caikuang_yinkuang:OnCreate(growPointType, x, y)
...
function gp_caikuang_yinkuang:OnOpen(selfId, targetId)
