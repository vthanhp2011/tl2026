...
local s_fengboe = class("s_fengboe", script_base)
s_fengboe.TBL = {
    ["IDX_TimerPrepare"] = 1,
    ["IDX_TimerInterval"] = 2,
    ["IDX_FlagCombat"] = 1,
...
s_fengboe.g_BuffId = 10175
function s_fengboe:OnDie(selfId, killerId)
...
function s_fengboe:OnHeartBeat(selfId, nTick) end

function s_fengboe:OnInit(selfId)
    self:MonsterAI_SetIntParamByIndex(selfId, self.TBL["IDX_TimerPrepare"], 0)
    self:MonsterAI_SetIntParamByIndex(selfId, self.TBL["IDX_TimerInterval"], 0)
    self:MonsterAI_SetBoolParamByIndex(selfId, self.TBL["IDX_FlagCombat"], 0)
end

function s_fengboe:OnKillCharacter(selfId, targetId) end

function s_fengboe:OnEnterCombat(selfId, enmeyId)
...
function s_fengboe:OnLeaveCombat(selfId)
    self:MonsterAI_SetIntParamByIndex(selfId, self.TBL["IDX_TimerPrepare"], 0)
    self:MonsterAI_SetIntParamByIndex(selfId, self.TBL["IDX_TimerInterval"], 0)
    self:MonsterAI_SetBoolParamByIndex(selfId, self.TBL["IDX_FlagCombat"], 0)
