...
local onanzhao_chuansong_1 = class("onanzhao_chuansong_1", script_base)
onanzhao_chuansong_1.script_id = 028030
onanzhao_chuansong_1.g_city0 = 221
onanzhao_chuansong_1.g_city1 = 239
onanzhao_chuansong_1.g_city2 = 613
onanzhao_chuansong_1.g_city3 = 631
function onanzhao_chuansong_1:OnDefaultEvent(selfId, targetId)
...
function onanzhao_chuansong_1:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
