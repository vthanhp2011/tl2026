...
local onanzhao_chuansong_2 = class("onanzhao_chuansong_2", script_base)
onanzhao_chuansong_2.script_id = 028031
onanzhao_chuansong_2.g_city0 = 257
onanzhao_chuansong_2.g_city1 = 275
onanzhao_chuansong_2.g_city2 = 649
onanzhao_chuansong_2.g_city3 = 667
function onanzhao_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function onanzhao_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
