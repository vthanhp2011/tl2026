...
local onanhai_chuansong_3 = class("onanhai_chuansong_3", script_base)
onanhai_chuansong_3.script_id = 034032
onanhai_chuansong_3.g_city0 = 291
onanhai_chuansong_3.g_city1 = 309
onanhai_chuansong_3.g_city2 = 683
onanhai_chuansong_3.g_city3 = 701
function onanhai_chuansong_3:OnDefaultEvent(selfId, targetId)
...
function onanhai_chuansong_3:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
