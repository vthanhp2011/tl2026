...
local onanhai_chargetransfer = class("onanhai_chargetransfer", script_base)
onanhai_chargetransfer.script_id = 400960
onanhai_chargetransfer.g_name = "车传信"
onanhai_chargetransfer.g_transfer_target = {
...
onanhai_chargetransfer.g_transfer_cost = 5000
function onanhai_chargetransfer:OnDefaultEvent(selfId, targetId)
    self:UpdateEventList(selfId, targetId)
end

function onanhai_chargetransfer:UpdateEventList(selfId, targetId)
...
function onanhai_chargetransfer:OnEventRequest(selfId, targetId, arg, index)
...
function onanhai_chargetransfer:NotifyFailTips(selfId, targetId, Tip)
    self:BeginEvent(self.script_id)
    self:AddText(Tip)
    self:EndEvent()
    self:DispatchEventList(selfId, targetId)
