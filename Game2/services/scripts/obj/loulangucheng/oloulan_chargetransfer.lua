...
local oloulan_chargetransfer = class("oloulan_chargetransfer", script_base)
oloulan_chargetransfer.script_id = 400959
oloulan_chargetransfer.g_name = "车传福"
oloulan_chargetransfer.g_transfer_target = {
...
oloulan_chargetransfer.g_transfer_cost = 5000
function oloulan_chargetransfer:OnDefaultEvent(selfId, targetId)
    self:UpdateEventList(selfId, targetId)
end

function oloulan_chargetransfer:UpdateEventList(selfId, targetId)
...
function oloulan_chargetransfer:OnEventRequest(selfId, targetId, arg, index)
