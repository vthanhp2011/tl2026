...
local oxihu_chuansong_2 = class("oxihu_chuansong_2", script_base)
oxihu_chuansong_2.script_id = 030031
oxihu_chuansong_2.g_city0 = 243
oxihu_chuansong_2.g_city1 = 261
oxihu_chuansong_2.g_city2 = 635
oxihu_chuansong_2.g_city3 = 653
function oxihu_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function oxihu_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
