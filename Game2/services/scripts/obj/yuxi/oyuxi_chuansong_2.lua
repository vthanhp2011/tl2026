...
local oyuxi_chuansong_2 = class("oyuxi_chuansong_2", script_base)
oyuxi_chuansong_2.script_id = 027031
oyuxi_chuansong_2.g_city0 = 252
oyuxi_chuansong_2.g_city1 = 270
oyuxi_chuansong_2.g_city2 = 644
oyuxi_chuansong_2.g_city3 = 662
function oyuxi_chuansong_2:OnDefaultEvent(selfId, targetId)
...
function oyuxi_chuansong_2:OnEventRequest(selfId, targetId, arg, index)
    if (index == 0) then
