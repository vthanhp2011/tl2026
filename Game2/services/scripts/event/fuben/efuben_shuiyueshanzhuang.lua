...
efuben_shuiyueshanzhuang.g_LimitMembers = 3
...
efuben_shuiyueshanzhuang.g_BOSSList =
{
	...
	["ShiSan_BOSS"]				= { DataID=48504, Title="", posX=125, posY=168, Dir=0, BaseAI=27, AIScript=0, ScriptID=892330,MsgData = "#{SYSZ_20210203_74}"},

	["FanWuJiu_NPC"]			= { DataID=48509, Title="", posX=125, posY=125, Dir=0, BaseAI=3, AIScript=0, ScriptID=892336,MsgData = ""},
	["FanWuJiu_BOSS"]			= { DataID=48510, Title="", posX=125, posY=125, Dir=0, BaseAI=27, AIScript=0, ScriptID=892331,MsgData = "#{SYSZ_20210203_77}"},

	["Aying_NPC"]				= { DataID=48516, Title="", posX=142, posY=65, Dir=0, BaseAI=3, AIScript=0, ScriptID=892337,MsgData = ""},
	["Aying_BOSS"]				= { DataID=48517, Title="", posX=142, posY=65, Dir=0, BaseAI=27, AIScript=0, ScriptID=892332,MsgData = "#{SYSZ_20210203_81}"},

	["YeLvHongYou_NPC"]				= { DataID=48520, Title="", posX=71, posY=65, Dir=0, BaseAI=3, AIScript=0, ScriptID=892338,MsgData = ""},
	["YeLvHongYou_BOSS"]			= { DataID=48521, Title="", posX=71, posY=65, Dir=0, BaseAI=27, AIScript=0, ScriptID=892334,MsgData = "#{SYSZ_20210203_84}"},
}
...
function efuben_shuiyueshanzhuang:MakeCopyScene(selfId)
    local param0 = 4
    local param1 = 3
    local mylevel
    local level0 = 0
...
function efuben_shuiyueshanzhuang:OnPlayerEnter(selfId )
	self:SetPlayerDefaultReliveInfo(selfId, 0.1, 0.1, 0, self:get_scene_id(), self.g_Fuben_X, self.g_Fuben_Z)
	...
	if takenTimes >= 3 then
		...
		self:notify_tips(selfId,"今日挑战次数已满")
		return
	end
