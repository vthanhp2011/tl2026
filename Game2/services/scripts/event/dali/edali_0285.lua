...
local edali_0285 = class("edali_0285", script_base)
edali_0285.script_id = 210285
edali_0285.g_busGuilList = {1000005, 1000006}
function edali_0285:OnDefaultEvent(selfId, targetId)
    local bSucceeded = 0
...
function edali_0285:OnEnumerate(caller)
    caller:AddNumTextWithTarget(self.script_id, "飞往杂货店", 9, -1)
end
