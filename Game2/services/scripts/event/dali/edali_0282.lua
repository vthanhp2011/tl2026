...
local edali_0282 = class("edali_0282", script_base)
edali_0282.script_id = 210282
edali_0282.g_busGuilList = {1000001, 1000002}
function edali_0282:OnDefaultEvent(selfId, targetId)
    local bSucceeded = 0
...
function edali_0282:OnEnumerate(caller)
    caller:AddNumTextWithTarget(self.script_id, "飞往西门", 9, -1)
end
