...
local edali_0281 = class("edali_0281", script_base)
edali_0281.script_id = 210281
edali_0281.g_busGuilList = {1000001, 1000002}
function edali_0281:OnDefaultEvent(selfId, targetId)
    local bSucceeded = 0
...
function edali_0281:OnEnumerate(caller, selfId, targetId, arg, index)
