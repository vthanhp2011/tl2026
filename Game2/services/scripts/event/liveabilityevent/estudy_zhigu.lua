...
local estudy_zhigu = class("estudy_zhigu", script_base)
estudy_zhigu.script_id = 713516
estudy_zhigu.g_MessageStudy = "如果你达到%d级并且肯花费#{_EXCHG%d}就可以学会制蛊技能。你决定学习么？"
estudy_zhigu.g_AbilityID = define.ABILITY_ZHIGU
estudy_zhigu.g_AbilityName = "制蛊"
function estudy_zhigu:OnDefaultEvent(selfId, targetId, ButtomNum, g_Npc_ScriptId)
...
function estudy_zhigu:OnEnumerate(caller, selfId, targetId, bid)
    caller:AddNumTextWithTarget(self.script_id, "学习" .. self.g_AbilityName .. "技能", 12, 0)
end

function estudy_zhigu:CheckAccept()

end

function estudy_zhigu:OnAccept()
