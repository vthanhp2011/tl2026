return {
    ["host_conf"] =
    {
        {id = 1, localip = "172.31.18.236", ip = "172.31.18.236", domain = "172.31.18.236", desc = "本地环境", netid = 1},
    },
    ["process_conf"] =
    {
        ...
        { id = 6, hostid = 1, desc = "工具服务-6", group = {2}, name = "Tool_tlbb_4"},
    },
    ["server_conf"] =
    {
        ...
        {id = 2016, name = "gamed", alias = ".gamed", processid = 2, desc = "游戏服", port = 4731, ctor_args = {}, init_args = {{address = "0.0.0.0", maxclient = 4096, nodelay = true, server_id = 10}}, private = false},
        {id = 2017, name = "logind", alias = ".logind", processid = 2, desc = "登录服", port = 4733, ctor_args = {}, init_args = {{address = "0.0.0.0", maxclient = 1024, nodelay = true, server_id = 10}}, private = false},
